...
export const procurementDemands: ProcurementDemand[] = [
  ...
  },
  {
    ...
    details: [],
    projectRows: [
      { id: 'PR_PD002_1', dept: '技术部', projectName: '舞台音响设备维修', mainContent: '主舞台音响系统全面检修 + 故障设备更换，含扬声器、功放、调音台等', budgetAmount: 35000, budgetControlAmount: 40000, approvalMeetingName: '2024年6月第4次采购审批会', approvalDate: '2024-06-25', remark: '' },
      { id: 'PR_PD002_2', dept: '技术部', projectName: '灯光控制台维修', mainContent: '3台灯光控制台返厂维修 + 备用控制设备采购', budgetAmount: 22000, budgetControlAmount: 25000, approvalMeetingName: '2024年6月第4次采购审批会', approvalDate: '2024-06-25', remark: '' },
    ],
  },
  {
    id: 'PD003',
  ...
  // DEMO-006: 实施项目 + 已通过 + 无下游（演示「发起变更」）
  {
    id: 'PD_DEMO_006',
    demandNo: 'CGQQ20260915001',
    demandType: 'implementation_project',
    procurementType: 'within_framework',
    procurementMode: 'meeting',
    applicant: '刘总监',
    ...
    projectName: '展馆空调系统维保工程（演示）',
    reason: '展馆空调系统进入维保期，需执行年度维保',
    status: 'approved',
    createTime: '2026-09-15 09:00:00',
    approveTime: '2026-09-15 11:30:00',
    approver: '王总',
    details: [],
    projectRows: [
      { id: 'PR_DEMO_006_1', dept: '工程部', projectName: '空调主机维保', mainContent: '空调主机年度维护保养 + 制冷剂检测补充', budgetAmount: 80000, budgetControlAmount: 100000, approvalDate: '2026-09-15' },
      { id: 'PR_DEMO_006_2', dept: '工程部', projectName: '末端风机盘管清洗', mainContent: '所有末端风机盘管拆解清洗 + 过滤网更换', budgetAmount: 45000, budgetControlAmount: 50000, approvalDate: '2026-09-15' },
    ],
  },
  // DEMO-007: 服务项目 + 已通过 + 无下游（演示「发起变更」）
  {
    id: 'PD_DEMO_007',
    demandNo: 'CGQQ20260916001',
    demandType: 'service_project',
    procurementType: 'outside_framework',
    procurementMode: 'sign_report',
    applicant: '陈经理',
    ...
    projectName: '展会期间保洁服务（演示）',
    reason: '展会期间场馆保洁服务外包需求',
    status: 'approved',
    createTime: '2026-09-16 08:00:00',
    approveTime: '2026-09-16 14:00:00',
    approver: '张总',
    details: [],
    projectRows: [
      { id: 'PR_DEMO_007_1', dept: '运营部', projectName: '主展馆保洁服务', mainContent: '展会期间每日 8:00-20:00 场馆公共区域保洁，含垃圾桶清运、地面清洁', budgetAmount: 60000, budgetControlAmount: 65000, approvalDate: '2026-09-16' },
    ],
  },
  // DEMO-008: 实施项目 + 待审批（审批通过后直接可发起变更）
  {
    id: 'PD_DEMO_008',
    demandNo: 'CGQQ20260917001',
    demandType: 'implementation_project',
    procurementType: 'within_framework',
    procurementMode: 'application_form',
    applicant: '李工',
    applicantDept: '工程部',
    applyDate: '2026-09-17',
    projectName: '展厅LED屏幕升级工程',
    reason: '主展厅 LED 屏幕使用 5 年，亮度衰减需升级',
    status: 'pending',
    createTime: '2026-09-17 10:00:00',
    details: [],
    projectRows: [
      { id: 'PR_DEMO_008_1', dept: '工程部', projectName: '主展厅LED升级', mainContent: '主展厅 P3 LED 屏幕整块更换，含钢结构加固', budgetAmount: 180000, budgetControlAmount: 200000, approvalDate: '2026-09-17' },
    ],
  },
  // DEMO-009: 服务项目 + 待审批（审批通过后直接可发起变更）
  {
    id: 'PD_DEMO_009',
    demandNo: 'CGQQ20260918001',
    demandType: 'service_project',
    procurementType: 'outside_framework',
    procurementMode: 'meeting',
    applicant: '赵运营',
    ...
    projectName: '观众登记系统运维服务',
    reason: '本届展会观众登记系统需外包运维支持',
    status: 'pending',
    createTime: '2026-09-18 14:00:00',
    details: [],
    projectRows: [
      { id: 'PR_DEMO_009_1', dept: '运营部', projectName: '观众登记系统运维', mainContent: '展会期间观众登记系统现场运维保障，含设备巡检、故障处理、数据备份', budgetAmount: 35000, budgetControlAmount: 40000, approvalDate: '2026-09-18' },
    ],
  },
  // DEMO-010: 实施项目 + 已审批 + application_form（采购项目申请表） + 3条projectRows + 无下游 —— 覆盖变更演示
  {
    id: 'PD_DEMO_010',
    demandNo: 'CGQQ20260919001',
    demandType: 'implementation_project',
    procurementType: 'outside_framework',
    procurementMode: 'application_form',
    applicant: '钱工程师',
    ...
    projectName: '主展厅照明系统改造工程',
    reason: '主展厅照明系统使用多年，部分灯具老化，需整体改造提升展厅照度',
    status: 'approved',
    createTime: '2026-09-19 09:30:00',
    approveTime: '2026-09-19 16:00:00',
    approver: '王总',
    details: [],
    projectRows: [
      { id: 'PR_DEMO_010_1', dept: '工程部', projectName: '主展厅LED筒灯替换', mainContent: '主展厅全部传统筒灯更换为LED节能筒灯，含灯具采购、安装、调试', budgetAmount: 156000, budgetControlAmount: 160000, approvalDate: '2026-09-19', remark: 'LED筒灯约800盏' },
      { id: 'PR_DEMO_010_2', dept: '工程部', projectName: '展厅照明智能控制改造', mainContent: '加装照明智能控制系统，支持分区调光、定时开关、人体感应', budgetAmount: 68000, budgetControlAmount: 75000, approvalDate: '2026-09-19', remark: '需配合弱电系统' },
      { id: 'PR_DEMO_010_3', dept: '工程部', projectName: '应急照明系统升级', mainContent: '更换应急疏散指示灯、应急照明灯，新增应急照明集中电源', budgetAmount: 32000, budgetControlAmount: 35000, approvalDate: '2026-09-19', remark: '消防验收要求' },
    ],
  },
  // DEMO-011: 服务项目 + 已审批 + meeting（会议审批） + 3条projectRows + 无下游 —— 覆盖变更演示
  {
    id: 'PD_DEMO_011',
    demandNo: 'CGQQ20260920001',
    demandType: 'service_project',
    procurementType: 'outside_framework',
    procurementMode: 'meeting',
    applicant: '孙运营',
    ...
    projectName: '本届展会配套服务外包（演示）',
    reason: '本届展会需配套多项现场服务，统一外包给专业服务商',
    status: 'approved',
    createTime: '2026-09-20 10:00:00',
    approveTime: '2026-09-20 14:30:00',
    approver: '张总',
    details: [],
    projectRows: [
      { id: 'PR_DEMO_011_1', dept: '运营部', projectName: '展会现场安保服务', mainContent: '展会期间24小时安保值守，含出入口安检、巡逻、应急处置', budgetAmount: 180000, budgetControlAmount: 200000, approvalMeetingName: '2026年展会项目采购审批会', approvalDate: '2026-09-20', remark: '约需安保人员30名' },
      { id: 'PR_DEMO_011_2', dept: '运营部', projectName: '观众引导与咨询服务', mainContent: '展会期间观众引导、咨询台服务、失物招领、医疗急救点值守', budgetAmount: 95000, budgetControlAmount: 100000, approvalMeetingName: '2026年展会项目采购审批会', approvalDate: '2026-09-20', remark: '' },
      { id: 'PR_DEMO_011_3', dept: '运营部', projectName: '展商技术支持服务', mainContent: '为参展商提供现场展具搭建协助、用电保障、网络支持等技术服务', budgetAmount: 120000, budgetControlAmount: 130000, approvalMeetingName: '2026年展会项目采购审批会', approvalDate: '2026-09-20', remark: '' },
    ],
  },
  // ===== 待立项（approved）/ 已立项（confirm_*）测试数据 =====
  // 物资类 - 已审批通过，等待立项确认（框架合同清单内）
  {
    id: 'PD_CONFIRM_MATERIAL',
    demandNo: 'CGQQ20260921001',
    projectName: '2026年Q4办公物资集中采购',
    applicant: '张三',
    applicantDept: '行政部',
    ...
    procurementType: 'within_framework',
    status: 'approved',
    createTime: '2026-09-21 09:30:00',
    approveTime: '2026-09-21 14:20:00',
    approver: '部门负责人A',
    details: [
      { id: 'MD_M_1', demandId: 'PD_CONFIRM_MATERIAL', productCode: 'WZ-OFFICE-001', productName: 'A4复印纸', specification: '80g 500张/包', unit: '包', quantity: 200, unitPriceExcludingTax: 22, unitPriceIncludingTax: 24.86, amountExcludingTax: 4400, amountIncludingTax: 4972, taxRate: 13 },
      { id: 'MD_M_2', demandId: 'PD_CONFIRM_MATERIAL', productCode: 'WZ-OFFICE-002', productName: '中性笔', specification: '0.5mm 黑色', unit: '支', quantity: 500, unitPriceExcludingTax: 1.2, unitPriceIncludingTax: 1.36, amountExcludingTax: 600, amountIncludingTax: 680, taxRate: 13 },
      { id: 'MD_M_3', demandId: 'PD_CONFIRM_MATERIAL', productCode: 'WZ-OFFICE-003', productName: '文件袋', specification: 'A4 加厚', unit: '个', quantity: 300, unitPriceExcludingTax: 3.5, unitPriceIncludingTax: 3.96, amountExcludingTax: 1050, amountIncludingTax: 1188, taxRate: 13 },
    ],
  },
  // 服务类 - 已审批通过，等待立项确认（非工程类-服务）
  {
    id: 'PD_CONFIRM_SERVICE',
    demandNo: 'CGQQ20260921002',
    projectName: '2026年度园区保洁服务外包',
    applicant: '李四',
    applicantDept: '后勤保障部',
    applyDate: '2026-09-21',
    reason: '园区年度保洁服务外包',
    ...
    procurementType: 'outside_framework',
    status: 'approved',
    createTime: '2026-09-21 10:15:00',
    approveTime: '2026-09-21 15:40:00',
    approver: '部门负责人B',
    details: [],
    projectRows: [
      { id: 'PR_SVC_1', dept: '后勤保障部', projectName: '日常保洁服务', mainContent: '园区公共区域日常清扫、垃圾清运、绿化养护', budgetAmount: 360000, budgetControlAmount: 380000, approvalDate: '' },
    ],
  },
  // 工程类 - 已审批通过，等待立项确认（工程类-施工）
  {
    id: 'PD_CONFIRM_ENG',
    demandNo: 'CGQQ20260921003',
    projectName: '会展中心三号馆地面翻新工程',
    applicant: '王五',
    applicantDept: '工程部',
    applyDate: '2026-09-21',
    reason: '三号馆地面翻新改造工程',
    ...
    procurementType: 'outside_framework',
    status: 'approved',
    createTime: '2026-09-21 11:00:00',
    approveTime: '2026-09-22 09:10:00',
    approver: '部门负责人C',
    details: [],
    projectRows: [
      { id: 'PR_ENG_1', dept: '工程部', projectName: '三号馆地面翻新', mainContent: '更换老化地毯为环保PVC地板，含基层处理、铺装、收边', budgetAmount: 850000, budgetControlAmount: 900000, approvalDate: '' },
    ],
  },
  // 物资类 - 已立项通过（confirm_approved），供下游招采执行系统过滤测试
  {
    id: 'PD_CONFIRM_APPROVED',
    demandNo: 'CGQQ20260920010',
    projectName: '2026年秋季展会物资采购',
    applicant: '赵六',
    applicantDept: '展览部',
    applyDate: '2026-09-18',
    reason: '秋季展会物资采购',
    ...
    isThreeImportant: false,
    createTime: '2026-09-18 14:00:00',
    approveTime: '2026-09-19 10:00:00',
    approver: '部门负责人A',
    confirmSubmitter: '赵六',
    confirmSubmitTime: '2026-09-19 16:30:00',
    confirmApprover: '分管领导',
    confirmApproveTime: '2026-09-20 11:00:00',
    details: [
      { id: 'MD_A_1', demandId: 'PD_CONFIRM_APPROVED', productCode: 'WZ-BOOTH-001', productName: '标准展位桁架', specification: '3m×3m 铝合金', unit: '套', quantity: 50, unitPriceExcludingTax: 1200, unitPriceIncludingTax: 1356, amountExcludingTax: 60000, amountIncludingTax: 67800, taxRate: 13 },
      { id: 'MD_A_2', demandId: 'PD_CONFIRM_APPROVED', productCode: 'WZ-BOOTH-002', productName: '展位地毯', specification: '红色 阻燃', unit: '平方米', quantity: 1500, unitPriceExcludingTax: 45, unitPriceIncludingTax: 50.85, amountExcludingTax: 67500, amountIncludingTax: 76275, taxRate: 13 },
    ],
  },
];
...
export const contractLedgers: ContractLedger[] = [
  ...
  },
  {
    ...
    formation: 'legal_bidding',
    winningDate: '2024-03-05',
    isModelText: true,
    archiveStatus: 'not_started',
    handlerContact: '13800000000',
  ...
  // ===== 非招采类合同样本 =====
  {
    ...
    archiveStatus: 'not_started',
    handlerContact: '13800000000',
    demandDepartment: '会展运营部',
    handlingDepartment: '运营管理部',
    handler: '王五',
    counterpartyName: '长沙国际会展中心有限公司',
    counterpartyContact: '赵六',
    mainContent: '2024年长沙国际车展场地租赁及现场运营服务，展期2024年10月1日-10月7日，总面积3万平米',
    signingDate: '2024-05-01',
    effectiveDate: '2024-10-01',
    terminationDate: '2024-10-07',
    amount: 1200,
    paidAmount: 600,
    performanceStatus: '进行中',
    ...
    status: 'active',
    // 非招采类合同独有字段
    performanceBond: { gateByFormation: true, isEnabled: true, amount: 120, receiveDate: '2024-04-25' },
  },
  {
    id: 'CL004',
    contractId: 'CT004',
    contractNo: 'HT20240615001',
    contractNature: 'non_procurement',
    contractName: '2024年度招商代理合同',
    category: 'investment',
    contractType: 'non_engineering',
    formation: 'investment_contract',
    isModelText: true,
    archiveStatus: 'not_started',
    handlerContact: '13800000000',
    demandDepartment: '招商部',
    handlingDepartment: '招商部',
    handler: '孙七',
    counterpartyName: '展商招商代理有限公司',
    counterpartyContact: '周八',
    mainContent: '委托招商代理公司负责2024年度展览会的展商招商工作，按实际招商展商数量结算佣金',
...
// ============================================================================
// 招采全链路 Demo 数据覆盖 v2（2026-09-17 重建）
...
// ------- 1. 覆盖 data.ts 已有的 6 个数组（清空 + push）-------
...
const _oldSuppliers = suppliers;
const _oldProcurementPlans = procurementPlans;
if (_procurementDemo.procurementDemands) { (_oldProcurementDemands as any).length = 0; (_oldProcurementDemands as any).push(..._procurementDemo.procurementDemands); }
if (_procurementDemo.contractLedgers) { (_oldContractLedgers as any).length = 0; (_oldContractLedgers as any).push(..._procurementDemo.contractLedgers); }
if (_procurementDemo.contractPurchaseOrders) { (_oldContractPurchaseOrders as any).length = 0; (_oldContractPurchaseOrders as any).push(..._procurementDemo.contractPurchaseOrders); }
if (_procurementDemo.procurementInspections) { (_oldProcurementInspections as any).length = 0; (_oldProcurementInspections as any).push(..._procurementDemo.procurementInspections); }
if (_procurementDemo.evaluationTemplates) { (_oldEvaluationTemplates as any).length = 0; (_oldEvaluationTemplates as any).push(..._procurementDemo.evaluationTemplates); }
if (_procurementDemo.evaluationRecords) { (_oldEvaluationRecords as any).length = 0; (_oldEvaluationRecords as any).push(..._procurementDemo.evaluationRecords); }
if (_procurementDemo.suppliers) { (_oldSuppliers as any).length = 0; (_oldSuppliers as any).push(..._procurementDemo.suppliers); }
if (_procurementDemo.procurementPlans) { (_oldProcurementPlans as any).length = 0; (_oldProcurementPlans as any).push(..._procurementDemo.procurementPlans); }
