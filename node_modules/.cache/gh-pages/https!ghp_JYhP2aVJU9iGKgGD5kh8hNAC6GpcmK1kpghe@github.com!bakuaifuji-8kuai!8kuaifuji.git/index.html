...
<html lang="zh-CN">
  <head>
    <meta charset="UTF-8" />
    <link rel="icon" type="image/svg+xml" href="/8kuaifuji/favicon.svg" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>仓库管理系统</title>
    <script type="module" crossorigin src="/8kuaifuji/assets/index-BN3U-eo1.js"></script>
    <link rel="stylesheet" crossorigin href="/8kuaifuji/assets/index-Adbi3gUF.css">
  </head>
  <body>
    <div id="root"></div>
