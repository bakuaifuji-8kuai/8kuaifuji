...
`},"getStyles"),Or=Rr,It=36,ft="actor-top",_t="actor-bottom",qt="actor-box",yt="actor-man",pt=new Set(["redux-color","redux-dark-color"]),Pt=x(function(e,t){const a=fr(e,t);return Ft().look==="neo"&&a.attr("data-look","neo"),a},"drawRect"),Lr=x(function(e,t,a,r,i){if(t.links===void 0||t.links===null||Object.keys(t.links).length===0)return{height:0,width:0};const n=t.links,s=t.actorCnt,o=t.rectData;var E="none";i&&(E="block !important");const h=e.append("g");h.attr("id","actor"+s+"_popup"),h.attr("class","actorPopupMenu"),h.attr("display",E);var p="";o.class!==void 0&&(p=" "+o.class);let _=o.width>a?o.width:a;const u=h.append("rect");if(u.attr("class","actorPopupMenuPanel"+p),u.attr("x",o.x),u.attr("y",o.height),u.attr("fill",o.fill),u.attr("stroke",o.stroke),u.attr("width",_),u.attr("height",o.height),u.attr("rx",o.rx),u.attr("ry",o.ry),n!=null){var O=20;for(let f in n){var T=h.append("a"),g=Me.sanitizeUrl(n[f]);T.attr("xlink:href",g),T.attr("target","_blank"),Gr(r)(f,T,o.x+10,o.height+O,_,20,{class:"actor"},r),O+=30}}return u.attr("height",O),{height:o.height+O,width:_}},"drawPopup"),zt=x(function(e){return"var pu = document.getElementById('"+e+"'); if (pu != null) { pu.style.display = pu.style.display == 'block' ? 'none' : 'block'; }"},"popupMenuToggle"),Ht=x(async function(e,t,a=null){let r=e.append("foreignObject");const i=await Ve(t.text,Ft()),s=r.append("xhtml:div").attr("style","width: fit-content;").attr("xmlns","http://www.w3.org/1999/xhtml").html(i).node().getBoundingClientRect();if(r.attr("height",Math.round(s.height)).attr("width",Math.round(s.width)),t.class==="noteText"){const o=e.node().firstChild;o.setAttribute("height",s.height+2*t.textMargin);const E=o.getBBox();r.attr("x",Math.round(E.x+E.width/2-s.width/2)).attr("y",Math.round(E.y+E.height/2-s.height/2))}else if(a){let{startx:o,stopx:E,starty:h}=a;if(o>E){const p=o;o=E,E=p}r.attr("x",Math.round(o+Math.abs(o-E)/2-s.width/2)),t.class==="loopText"?r.attr("y",Math.round(h)):r.attr("y",Math.round(h-s.height))}return[r]},"drawKatex"),St=x(function(e,t){let a=0,r=0;const i=t.text.split(m.lineBreakRegex),[n,s]=Be(t.fontSize);let o=[],E=0,h=x(()=>t.y,"yfunc");if(t.valign!==void 0&&t.textMargin!==void 0&&t.textMargin>0)switch(t.valign){case"top":case"start":h=x(()=>Math.round(t.y+t.textMargin),"yfunc");break;case"middle":case"center":h=x(()=>Math.round(t.y+(a+r+t.textMargin)/2),"yfunc");break;case"bottom":case"end":h=x(()=>Math.round(t.y+(a+r+2*t.textMargin)-t.textMargin),"yfunc");break}if(t.anchor!==void 0&&t.textMargin!==void 0&&t.width!==void 0)switch(t.anchor){case"left":case"start":t.x=Math.round(t.x+t.textMargin),t.anchor="start",t.dominantBaseline="middle",t.alignmentBaseline="middle";break;case"middle":case"center":t.x=Math.round(t.x+t.width/2),t.anchor="middle",t.dominantBaseline="middle",t.alignmentBaseline="middle";break;case"right":case"end":t.x=Math.round(t.x+t.width-t.textMargin),t.anchor="end",t.dominantBaseline="middle",t.alignmentBaseline="middle";break}for(let[p,_]of i.entries()){t.textMargin!==void 0&&t.textMargin===0&&n!==void 0&&(E=p*n);const u=e.append("text");u.attr("x",t.x),u.attr("y",h()),t.anchor!==void 0&&u.attr("text-anchor",t.anchor).attr("dominant-baseline",t.dominantBaseline).attr("alignment-baseline",t.alignmentBaseline),t.fontFamily!==void 0&&u.style("font-family",t.fontFamily),s!==void 0&&u.style("font-size",s),t.fontWeight!==void 0&&u.style("font-weight",t.fontWeight),t.fill!==void 0&&u.attr("fill",t.fill),t.class!==void 0&&u.attr("class",t.class),t.dy!==void 0?u.attr("dy",t.dy):E!==0&&u.attr("dy",E);const O=_||pr;if(t.tspan){const T=u.append("tspan");T.attr("x",t.x),t.fill!==void 0&&T.attr("fill",t.fill),T.text(O)}else u.text(O);t.valign!==void 0&&t.textMargin!==void 0&&t.textMargin>0&&(r+=(u._groups||u)[0][0].getBBox().height,a=r),o.push(u)}return o},"drawText"),Ye=x(function(e,t){function a(i,n,s,o,E){return i+","+n+" "+(i+s)+","+n+" "+(i+s)+","+(n+o-E)+" "+(i+s-E*1.2)+","+(n+o)+" "+i+","+(n+o)}x(a,"genPoints");const r=e.append("polygon");return r.attr("points",a(t.x,t.y,t.width,t.height,7)),r.attr("class","labelBox"),t.y=t.y+t.height/2,St(e,t),r},"drawLabel"),B=-1,We=x((e,t,a,r)=>{e.select&&a.forEach(i=>{const n=t.get(i),s=e.select("#actor"+n.actorCnt);!r.mirrorActors&&n.stopy?s.attr("y2",n.stopy+n.height/2):r.mirrorActors&&s.attr("y2",n.stopy)})},"fixLifeLineHeights"),br=x(function(e,t,a,r,i){var P,S;const n=r?t.stopy:t.starty,s=t.x+t.width/2,o=n+t.height,{look:E,theme:h,themeVariables:p}=a,{bkgColorArray:_,borderColorArray:u}=p,O=e.append("g").lower();var T=O;r||(B++,Object.keys(t.links||{}).length&&!a.forceMenus&&T.attr("onclick",zt(`actor${B}_popup`)).attr("cursor","pointer"),T.append("line").attr("id","actor"+B).attr("x1",s).attr("y1",o).attr("x2",s).attr("y2",2e3).attr("class","actor-line 200").attr("stroke-width","0.5px").attr("stroke","#999").attr("name",t.name).attr("data-et","life-line").attr("data-id",t.name),T=O.append("g"),t.actorCnt=B,t.links!=null&&T.attr("id","root-"+B),E==="neo"&&T.attr("data-look","neo"));const g=dt();var f="actor";(P=t.properties)!=null&&P.class?f=t.properties.class:g.fill="#eaeaea",r?f+=` ${_t}`:f+=` ${ft}`,g.x=t.x,g.y=n,g.width=t.width,g.height=t.height,g.class=f,g.rx=3,g.ry=3,g.name=t.name,E==="neo"&&(g.rx=6,g.ry=6);const I=Pt(T,g),L=i.get(t.name)??0;if(pt.has(h)&&(I.style("stroke",u[L%u.length]),I.style("fill",_[L%u.length])),E==="neo"&&I.attr("filter","url(#drop-shadow)"),t.rectData=g,(S=t.properties)!=null&&S.icon){const w=t.properties.icon.trim();w.charAt(0)==="@"?ie(T,g.x+g.width-20,g.y+10,w.substr(1)):ne(T,g.x+g.width-20,g.y+10,w)}r||(T.attr("data-et","participant"),T.attr("data-type","participant"),T.attr("data-id",t.name)),Et(a,Q(t.description))(t.description,T,g.x,g.y,g.width,g.height,{class:`actor ${qt}`},a);let b=t.height;if(I.node){const w=I.node().getBBox();t.height=w.height,b=w.height}return b},"drawActorTypeParticipant"),Ar=x(function(e,t,a,r,i){var M,V;const n=r?t.stopy:t.starty,s=t.x+t.width/2,o=n+t.height,{look:E,theme:h,themeVariables:p}=a,{bkgColorArray:_,borderColorArray:u}=p,O=e.append("g").lower();var T=O;r||(B++,Object.keys(t.links||{}).length&&!a.forceMenus&&T.attr("onclick",zt(`actor${B}_popup`)).attr("cursor","pointer"),T.append("line").attr("id","actor"+B).attr("x1",s).attr("y1",o).attr("x2",s).attr("y2",2e3).attr("class","actor-line 200").attr("stroke-width","0.5px").attr("stroke","#999").attr("name",t.name).attr("data-et","life-line").attr("data-id",t.name),T=O.append("g"),t.actorCnt=B,t.links!=null&&T.attr("id","root-"+B),E==="neo"&&T.attr("data-look","neo"));const g=dt();var f="actor";(M=t.properties)!=null&&M.class?f=t.properties.class:g.fill="#eaeaea",r?f+=` ${_t}`:f+=` ${ft}`,g.x=t.x,g.y=n,g.width=t.width,g.height=t.height,g.class=f,g.name=t.name;const I=6,L={...g,x:g.x+-I,y:g.y+ +I,class:"actor"},b=Pt(T,g),P=Pt(T,L);t.rectData=g,E==="neo"&&T.attr("filter","url(#drop-shadow)");const S=i.get(t.name)??0;if(pt.has(h)&&(b.style("stroke",u[S%u.length]),b.style("fill",_[S%u.length]),P.style("stroke",u[S%u.length]),P.style("fill",_[S%u.length])),(V=t.properties)!=null&&V.icon){const Y=t.properties.icon.trim();Y.charAt(0)==="@"?ie(T,g.x+g.width-20,g.y+10,Y.substr(1)):ne(T,g.x+g.width-20,g.y+10,Y)}Et(a,Q(t.description))(t.description,T,g.x-I,g.y+I,g.width,g.height,{class:`actor ${qt}`},a);let w=t.height;if(b.node){const Y=b.node().getBBox();t.height=Y.height,w=Y.height}return r||(T.attr("data-et","participant"),T.attr("data-type","collections"),T.attr("data-id",t.name)),w},"drawActorTypeCollections"),Sr=x(function(e,t,a,r,i){var Y,z;const n=r?t.stopy:t.starty,s=t.x+t.width/2,o=n+t.height,{look:E,theme:h,themeVariables:p}=a,{bkgColorArray:_,borderColorArray:u}=p,O=e.append("g").lower();let T=O;r||(B++,Object.keys(t.links||{}).length&&!a.forceMenus&&T.attr("onclick",zt(`actor${B}_popup`)).attr("cursor","pointer"),T.append("line").attr("id","actor"+B).attr("x1",s).attr("y1",o).attr("x2",s).attr("y2",2e3).attr("class","actor-line 200").attr("stroke-width","0.5px").attr("stroke","#999").attr("name",t.name).attr("data-et","life-line").attr("data-id",t.name),T=O.append("g"),t.actorCnt=B,t.links!=null&&T.attr("id","root-"+B),E==="neo"&&T.attr("data-look","neo"));const g=dt();let f="actor";(Y=t.properties)!=null&&Y.class?f=t.properties.class:g.fill="#eaeaea",r?f+=` ${_t}`:f+=` ${ft}`,T.attr("class",f),g.x=t.x,g.y=n,g.width=t.width,g.height=t.height,g.name=t.name;const I=g.height/2,L=I/(2.5+g.height/50),b=T.append("g"),P=T.append("g"),S=`M ${g.x},${g.y+I}
    a ${L},${I} 0 0 0 0,${g.height}
    h ${g.width-2*L}
    a ${L},${I} 0 0 0 0,-${g.height}
    Z
  `;b.append("path").attr("d",S),P.append("path").attr("d",`M ${g.x},${g.y+I}
      a ${L},${I} 0 0 0 0,${g.height}`),b.attr("transform",`translate(${L}, ${-(g.height/2)})`),P.attr("transform",`translate(${g.width-L}, ${-g.height/2})`),t.rectData=g,E==="neo"&&b.attr("filter","url(#drop-shadow)");const w=i.get(t.name)??0;if(pt.has(h)&&(b.style("stroke",u[w%u.length]),b.style("fill",_[w%u.length]),P.style("stroke",u[w%u.length]),P.style("fill",_[w%u.length])),(z=t.properties)!=null&&z.icon){const K=t.properties.icon.trim(),X=g.x+g.width-20,$=g.y+10;K.charAt(0)==="@"?ie(T,X,$,K.substr(1)):ne(T,X,$,K)}Et(a,Q(t.description))(t.description,T,g.x,g.y,g.width,g.height,{class:`actor ${qt}`},a);let M=t.height;const V=b.select("path:last-child");if(V.node()){const K=V.node().getBBox();t.height=K.height,M=K.height}return r||(T.attr("data-et","participant"),T.attr("data-type","queue"),T.attr("data-id",t.name)),M},"drawActorTypeQueue"),wr=x(function(e,t,a,r,i,n){var Y;const s=r?t.stopy:t.starty,o=t.x+t.width/2,E=s+75,{look:h,theme:p,themeVariables:_}=a,{bkgColorArray:u,borderColorArray:O,actorBorder:T,actorBkg:g}=_,f=e.append("g").lower();r||(B++,f.append("line").attr("id","actor"+B).attr("x1",o).attr("y1",E).attr("x2",o).attr("y2",2e3).attr("class","actor-line 200").attr("stroke-width","0.5px").attr("stroke","#999").attr("name",t.name).attr("data-et","life-line").attr("data-id",t.name),t.actorCnt=B);const I=e.append("g");let L=yt;r?L+=` ${_t}`:L+=` ${ft}`,I.attr("class",L),I.attr("name",t.name);const b=dt();b.x=t.x,b.y=s,b.fill="#eaeaea",b.width=t.width,b.height=t.height,b.class="actor";const P=t.x+t.width/2,S=s+32,w=22;I.append("defs").append("marker").attr("id",i+"-filled-head-control").attr("refX",11).attr("refY",5.8).attr("markerWidth",20).attr("markerHeight",28).attr("orient","172.5").attr("stroke-width",1.2).append("path").attr("d","M 14.4 5.6 L 7.2 10.4 L 8.8 5.6 L 7.2 0.8 Z"),I.append("circle").attr("cx",P).attr("cy",S).attr("r",w).attr("filter",`${h==="neo"?"url(#drop-shadow)":""}`),I.append("line").attr("marker-end","url(#"+i+"-filled-head-control)").attr("transform",`translate(${P}, ${S-w})`);const M=n.get(t.name)??0;pt.has(p)?(I.style("stroke",O[M%O.length]),I.style("fill",u[M%O.length])):(I.style("stroke",T),I.style("fill",g));const V=I.node().getBBox();return t.height=V.height+2*(((Y=a==null?void 0:a.sequence)==null?void 0:Y.labelBoxHeight)??0),Et(a,Q(t.description))(t.description,I,b.x,b.y+w+(r?5:12),b.width,b.height,{class:`actor ${yt}`},a),r||(I.attr("data-et","participant"),I.attr("data-type","control"),I.attr("data-id",t.name)),t.height},"drawActorTypeControl"),Nr=x(function(e,t,a,r,i){var w;const n=r?t.stopy:t.starty,s=t.x+t.width/2,o=n+75,{look:E,theme:h,themeVariables:p}=a,{bkgColorArray:_,borderColorArray:u}=p,O=e.append("g").lower(),T=e.append("g");let g="actor";r?g+=` ${_t}`:g+=` ${ft}`,T.attr("class",g),T.attr("name",t.name);const f=dt();f.x=t.x,f.y=n,f.fill="#eaeaea",f.width=t.width,f.height=t.height,f.class="actor";const I=t.x+t.width/2,L=n+(r?10:25),b=22;T.append("circle").attr("cx",I).attr("cy",L).attr("r",b).attr("width",t.width).attr("height",t.height),T.append("line").attr("x1",I-b).attr("x2",I+b).attr("y1",L+b).attr("y2",L+b).attr("stroke-width",2),E==="neo"&&T.attr("filter","url(#drop-shadow)");const P=i.get(t.name)??0;pt.has(h)&&(T.style("stroke",u[P%u.length]),T.style("fill",_[P%u.length]));const S=T.node().getBBox();return t.height=S.height+(((w=a==null?void 0:a.sequence)==null?void 0:w.labelBoxHeight)??0),r||(B++,O.append("line").attr("id","actor"+B).attr("x1",s).attr("y1",o).attr("x2",s).attr("y2",2e3).attr("class","actor-line 200").attr("stroke-width","0.5px").attr("stroke","#999").attr("name",t.name).attr("data-et","life-line").attr("data-id",t.name),t.actorCnt=B),Et(a,Q(t.description))(t.description,T,f.x,f.y+(r?15:30),f.width,f.height,{class:`actor ${yt}`},a),r?T.attr("transform",`translate(0, ${b})`):(T.attr("transform",`translate(0, ${b/2-5})`),T.attr("data-et","participant"),T.attr("data-type","entity"),T.attr("data-id",t.name)),t.height},"drawActorTypeEntity"),mr=x(function(e,t,a,r,i){var z;const n=r?t.stopy:t.starty,s=t.x+t.width/2,o=n+t.height+2*a.boxTextMargin,{theme:E,themeVariables:h,look:p}=a,{bkgColorArray:_,borderColorArray:u,actorBorder:O}=h,T=e.append("g").lower();let g=T;r||(B++,Object.keys(t.links||{}).length&&!a.forceMenus&&g.attr("onclick",zt(`actor${B}_popup`)).attr("cursor","pointer"),g.append("line").attr("id","actor"+B).attr("x1",s).attr("y1",o).attr("x2",s).attr("y2",2e3).attr("class","actor-line 200").attr("stroke-width","0.5px").attr("stroke","#999").attr("name",t.name).attr("data-et","life-line").attr("data-id",t.name),g=T.append("g"),t.actorCnt=B,t.links!=null&&g.attr("id","root-"+B),p==="neo"&&g.attr("data-look","neo"));const f=dt();let I="actor";(z=t.properties)!=null&&z.class?I=t.properties.class:f.fill="#eaeaea",r?I+=` ${_t}`:I+=` ${ft}`,f.x=t.x,f.y=n,f.width=t.width,f.height=t.height,f.class=I,f.name=t.name,f.x=t.x,f.y=n;const L=f.width/3,b=f.width/3,P=L/2,S=P/(2.5+L/50),w=g.append("g");w.attr("class",I);const M=`
  M ${f.x},${f.y+S}
  a ${P},${S} 0 0 0 ${L},0
  a ${P},${S} 0 0 0 -${L},0
  l 0,${b-2*S}
  a ${P},${S} 0 0 0 ${L},0
  l 0,-${b-2*S}
`;w.append("path").attr("d",M),p==="neo"&&w.attr("filter","url(#drop-shadow)");const V=i.get(t.name)??0;pt.has(E)?(w.style("stroke",u[V%u.length]),w.style("fill",_[V%u.length])):w.style("stroke",O),w.attr("transform",`translate(${L}, ${S})`),t.rectData=f,Et(a,Q(t.description))(t.description,g,f.x,f.y+35,f.width,f.height,{class:`actor ${qt}`},a);const Y=w.select("path:last-child");if(Y.node()){const K=Y.node().getBBox();t.height=K.height+(a.sequence.labelBoxHeight??0)}return r||(g.attr("data-et","participant"),g.attr("data-type","database"),g.attr("data-id",t.name)),t.height},"drawActorTypeDatabase"),Pr=x(function(e,t,a,r,i){const n=r?t.stopy:t.starty,s=t.x+t.width/2,o=n+80,E=22,h=e.append("g").lower(),{look:p,theme:_,themeVariables:u}=a,{bkgColorArray:O,borderColorArray:T,actorBorder:g}=u;r||(B++,h.append("line").attr("id","actor"+B).attr("x1",s).attr("y1",o).attr("x2",s).attr("y2",2e3).attr("class","actor-line 200").attr("stroke-width","0.5px").attr("stroke","#999").attr("name",t.name).attr("data-et","life-line").attr("data-id",t.name),t.actorCnt=B);const f=e.append("g");let I=yt;r?I+=` ${_t}`:I+=` ${ft}`,f.attr("class",I),f.attr("name",t.name);const L=dt();L.x=t.x,L.y=n,L.fill="#eaeaea",L.width=t.width,L.height=t.height,L.class="actor",f.append("line").attr("id","actor-man-torso"+B).attr("x1",t.x+t.width/2-E*2.5).attr("y1",n+12).attr("x2",t.x+t.width/2-15).attr("y2",n+12),f.append("line").attr("id","actor-man-arms"+B).attr("x1",t.x+t.width/2-E*2.5).attr("y1",n+2).attr("x2",t.x+t.width/2-E*2.5).attr("y2",n+22),f.append("circle").attr("cx",t.x+t.width/2).attr("cy",n+12).attr("r",E),p==="neo"&&f.attr("filter","url(#drop-shadow)");const b=i.get(t.name)??0;pt.has(_)?(f.style("stroke",T[b%T.length]),f.style("fill",O[b%T.length])):f.style("stroke",g);const P=f.node().getBBox();return t.height=P.height+(a.sequence.labelBoxHeight??0),Et(a,Q(t.description))(t.description,f,L.x,L.y+15,L.width,L.height,{class:`actor ${yt}`},a),f.attr("transform",`translate(0,${E/2+10})`),r||(f.attr("data-et","participant"),f.attr("data-type","boundary"),f.attr("data-id",t.name)),t.height},"drawActorTypeBoundary"),kr=x(function(e,t,a,r,i){const n=r?t.stopy:t.starty,s=t.x+t.width/2,o=n+80,{look:E,theme:h,themeVariables:p}=a,{bkgColorArray:_,borderColorArray:u,actorBorder:O}=p,T=e.append("g").lower();r||(B++,T.append("line").attr("id","actor"+B).attr("x1",s).attr("y1",o).attr("x2",s).attr("y2",2e3).attr("class","actor-line 200").attr("stroke-width","0.5px").attr("stroke","#999").attr("name",t.name).attr("data-et","life-line").attr("data-id",t.name),t.actorCnt=B);const g=e.append("g");let f=yt;r?f+=` ${_t}`:f+=` ${ft}`,g.attr("class",f),g.attr("name",t.name),r||g.attr("data-et","participant").attr("data-type","actor").attr("data-id",t.name);const I=E==="neo"?.5:1,L=E==="neo"?n+(1-I)*30:n;g.append("line").attr("id","actor-man-torso"+B).attr("x1",s).attr("y1",L+25*I).attr("x2",s).attr("y2",L+45*I),g.append("line").attr("id","actor-man-arms"+B).attr("x1",s-It/2*I).attr("y1",L+33*I).attr("x2",s+It/2*I).attr("y2",L+33*I),g.append("line").attr("x1",s-It/2*I).attr("y1",L+60*I).attr("x2",s).attr("y2",L+45*I),g.append("line").attr("x1",s).attr("y1",L+45*I).attr("x2",s+(It/2-2)*I).attr("y2",L+60*I);const b=g.append("circle");b.attr("cx",t.x+t.width/2),b.attr("cy",L+10*I),b.attr("r",15*I),b.attr("width",t.width*I),b.attr("height",t.height*I);const P=g.node().getBBox();t.height=P.height;const S=dt();S.x=t.x,S.y=L,S.fill="#eaeaea",S.width=t.width,S.height=t.height/I,S.class="actor",S.rx=3,S.ry=3;const w=i.get(t.name)??0;return pt.has(h)?(g.style("stroke",u[w%u.length]),g.style("fill",_[w%u.length])):g.style("stroke",O),Et(a,Q(t.description))(t.description,g,S.x,L+35*I-(E==="neo"?10:0),S.width,S.height,{class:`actor ${yt}`},a),t.height},"drawActorTypeActor"),Dr=x(async function(e,t,a,r,i,n,s){const o=s??new Map([...n.db.getActors().values()].map((E,h)=>[E.name,h]));switch(t.type){case"actor":return await kr(e,t,a,r,o);case"participant":return await br(e,t,a,r,o);case"boundary":return await Pr(e,t,a,r,o);case"control":return await wr(e,t,a,r,i,o);case"entity":return await Nr(e,t,a,r,o);case"database":return await mr(e,t,a,r,o);case"collections":return await Ar(e,t,a,r,o);case"queue":return await Sr(e,t,a,r,o)}},"drawActor"),vr=x(function(e,t,a){const i=e.append("g");Ke(i,t),t.name&&Et(a)(t.name,i,t.x,t.y+a.boxTextMargin+(t.textMaxHeight||0)/2,t.width,0,{class:"text"},a),i.lower()},"drawBox"),Cr=x(function(e){return e.append("g")},"anchorElement"),Mr=x(function(e,t,a,r,i,n,s){const{theme:o,themeVariables:E}=r,{bkgColorArray:h,borderColorArray:p,mainBkg:_}=E,u=dt(),O=t.anchored,T=t.actor;u.x=t.startx,u.y=t.starty,u.class="activation"+i%3,u.width=t.stopx-t.startx,u.height=a-t.starty;const g=Pt(O,u),I=(s??new Map([...n.db.getActors().values()].map((L,b)=>[L.name,b]))).get(T)??0;pt.has(o)&&(g.style("stroke",p[I%p.length]),g.style("fill",h[I%p.length]??_))},"drawActivation"),Br=x(async function(e,t,a,r,i){const{boxMargin:n,boxTextMargin:s,labelBoxHeight:o,labelBoxWidth:E,messageFontFamily:h,messageFontSize:p,messageFontWeight:_}=r,u=e.append("g").attr("data-et","control-structure").attr("data-id","i"+i.id),O=x(function(f,I,L,b){return u.append("line").attr("x1",f).attr("y1",I).attr("x2",L).attr("y2",b).attr("class","loopLine")},"drawLoopLine");O(t.startx,t.starty,t.stopx,t.starty),O(t.stopx,t.starty,t.stopx,t.stopy),O(t.startx,t.stopy,t.stopx,t.stopy),O(t.startx,t.starty,t.startx,t.stopy),t.sections!==void 0&&t.sections.forEach(function(f){O(t.startx,f.y,t.stopx,f.y).style("stroke-dasharray","3, 3")});let T=se();T.text=a,T.x=t.startx,T.y=t.starty,T.fontFamily=h,T.fontSize=p,T.fontWeight=_,T.anchor="middle",T.valign="middle",T.tspan=!1,T.width=Math.max(E??0,50),T.height=o+(r.look==="neo"?15:0)||20,T.textMargin=s,T.class="labelText",Ye(u,T),T=Fe(),T.text=t.title,T.x=t.startx+E/2+(t.stopx-t.startx)/2,T.y=t.starty+n+s,T.anchor="middle",T.valign="middle",T.textMargin=s,T.class="loopText",T.fontFamily=h,T.fontSize=p,T.fontWeight=_,T.wrap=!0;let g=Q(T.text)?await Ht(u,T,t):St(u,T);if(t.sectionTitles!==void 0){for(const[f,I]of Object.entries(t.sectionTitles))if(I.message){T.text=I.message,T.x=t.startx+(t.stopx-t.startx)/2,T.y=t.sections[f].y+n+s,T.class="sectionTitle",T.anchor="middle",T.valign="middle",T.tspan=!1,T.fontFamily=h,T.fontSize=p,T.fontWeight=_,T.wrap=t.wrap,Q(T.text)?(t.starty=t.sections[f].y,await Ht(u,T,t)):St(u,T);let L=Math.round(g.map(b=>(b._groups||b)[0][0].getBBox().height).reduce((b,P)=>b+P));t.sections[f].height+=L-(n+s)}}return t.height=Math.round(t.stopy-t.starty),u},"drawLoop"),Ke=x(function(e,t){ur(e,t)},"drawBackgroundRect"),Vr=x(function(e,t){e.append("defs").append("symbol").attr("id",t+"-database").attr("fill-rule","evenodd").attr("clip-rule","evenodd").append("path").attr("transform","scale(.5)").attr("d","M12.258.001l.256.004.255.005.253.008.251.01.249.012.247.015.246.016.242.019.241.02.239.023.236.024.233.027.231.028.229.031.225.032.223.034.22.036.217.038.214.04.211.041.208.043.205.045.201.046.198.048.194.05.191.051.187.053.183.054.18.056.175.057.172.059.168.06.163.061.16.063.155.064.15.066.074.033.073.033.071.034.07.034.069.035.068.035.067.035.066.035.064.036.064.036.062.036.06.036.06.037.058.037.058.037.055.038.055.038.053.038.052.038.051.039.05.039.048.039.047.039.045.04.044.04.043.04.041.04.04.041.039.041.037.041.036.041.034.041.033.042.032.042.03.042.029.042.027.042.026.043.024.043.023.043.021.043.02.043.018.044.017.043.015.044.013.044.012.044.011.045.009.044.007.045.006.045.004.045.002.045.001.045v17l-.001.045-.002.045-.004.045-.006.045-.007.045-.009.044-.011.045-.012.044-.013.044-.015.044-.017.043-.018.044-.02.043-.021.043-.023.043-.024.043-.026.043-.027.042-.029.042-.03.042-.032.042-.033.042-.034.041-.036.041-.037.041-.039.041-.04.041-.041.04-.043.04-.044.04-.045.04-.047.039-.048.039-.05.039-.051.039-.052.038-.053.038-.055.038-.055.038-.058.037-.058.037-.06.037-.06.036-.062.036-.064.036-.064.036-.066.035-.067.035-.068.035-.069.035-.07.034-.071.034-.073.033-.074.033-.15.066-.155.064-.16.063-.163.061-.168.06-.172.059-.175.057-.18.056-.183.054-.187.053-.191.051-.194.05-.198.048-.201.046-.205.045-.208.043-.211.041-.214.04-.217.038-.22.036-.223.034-.225.032-.229.031-.231.028-.233.027-.236.024-.239.023-.241.02-.242.019-.246.016-.247.015-.249.012-.251.01-.253.008-.255.005-.256.004-.258.001-.258-.001-.256-.004-.255-.005-.253-.008-.251-.01-.249-.012-.247-.015-.245-.016-.243-.019-.241-.02-.238-.023-.236-.024-.234-.027-.231-.028-.228-.031-.226-.032-.223-.034-.22-.036-.217-.038-.214-.04-.211-.041-.208-.043-.204-.045-.201-.046-.198-.048-.195-.05-.19-.051-.187-.053-.184-.054-.179-.056-.176-.057-.172-.059-.167-.06-.164-.061-.159-.063-.155-.064-.151-.066-.074-.033-.072-.033-.072-.034-.07-.034-.069-.035-.068-.035-.067-.035-.066-.035-.064-.036-.063-.036-.062-.036-.061-.036-.06-.037-.058-.037-.057-.037-.056-.038-.055-.038-.053-.038-.052-.038-.051-.039-.049-.039-.049-.039-.046-.039-.046-.04-.044-.04-.043-.04-.041-.04-.04-.041-.039-.041-.037-.041-.036-.041-.034-.041-.033-.042-.032-.042-.03-.042-.029-.042-.027-.042-.026-.043-.024-.043-.023-.043-.021-.043-.02-.043-.018-.044-.017-.043-.015-.044-.013-.044-.012-.044-.011-.045-.009-.044-.007-.045-.006-.045-.004-.045-.002-.045-.001-.045v-17l.001-.045.002-.045.004-.045.006-.045.007-.045.009-.044.011-.045.012-.044.013-.044.015-.044.017-.043.018-.044.02-.043.021-.043.023-.043.024-.043.026-.043.027-.042.029-.042.03-.042.032-.042.033-.042.034-.041.036-.041.037-.041.039-.041.04-.041.041-.04.043-.04.044-.04.046-.04.046-.039.049-.039.049-.039.051-.039.052-.038.053-.038.055-.038.056-.038.057-.037.058-.037.06-.037.061-.036.062-.036.063-.036.064-.036.066-.035.067-.035.068-.035.069-.035.07-.034.072-.034.072-.033.074-.033.151-.066.155-.064.159-.063.164-.061.167-.06.172-.059.176-.057.179-.056.184-.054.187-.053.19-.051.195-.05.198-.048.201-.046.204-.045.208-.043.211-.041.214-.04.217-.038.22-.036.223-.034.226-.032.228-.031.231-.028.234-.027.236-.024.238-.023.241-.02.243-.019.245-.016.247-.015.249-.012.251-.01.253-.008.255-.005.256-.004.258-.001.258.001zm-9.258 20.499v.01l.001.021.003.021.004.022.005.021.006.022.007.022.009.023.01.022.011.023.012.023.013.023.015.023.016.024.017.023.018.024.019.024.021.024.022.025.023.024.024.025.052.049.056.05.061.051.066.051.07.051.075.051.079.052.084.052.088.052.092.052.097.052.102.051.105.052.11.052.114.051.119.051.123.051.127.05.131.05.135.05.139.048.144.049.147.047.152.047.155.047.16.045.163.045.167.043.171.043.176.041.178.041.183.039.187.039.19.037.194.035.197.035.202.033.204.031.209.03.212.029.216.027.219.025.222.024.226.021.23.02.233.018.236.016.24.015.243.012.246.01.249.008.253.005.256.004.259.001.26-.001.257-.004.254-.005.25-.008.247-.011.244-.012.241-.014.237-.016.233-.018.231-.021.226-.021.224-.024.22-.026.216-.027.212-.028.21-.031.205-.031.202-.034.198-.034.194-.036.191-.037.187-.039.183-.04.179-.04.175-.042.172-.043.168-.044.163-.045.16-.046.155-.046.152-.047.148-.048.143-.049.139-.049.136-.05.131-.05.126-.05.123-.051.118-.052.114-.051.11-.052.106-.052.101-.052.096-.052.092-.052.088-.053.083-.051.079-.052.074-.052.07-.051.065-.051.06-.051.056-.05.051-.05.023-.024.023-.025.021-.024.02-.024.019-.024.018-.024.017-.024.015-.023.014-.024.013-.023.012-.023.01-.023.01-.022.008-.022.006-.022.006-.022.004-.022.004-.021.001-.021.001-.021v-4.127l-.077.055-.08.053-.083.054-.085.053-.087.052-.09.052-.093.051-.095.05-.097.05-.1.049-.102.049-.105.048-.106.047-.109.047-.111.046-.114.045-.115.045-.118.044-.12.043-.122.042-.124.042-.126.041-.128.04-.13.04-.132.038-.134.038-.135.037-.138.037-.139.035-.142.035-.143.034-.144.033-.147.032-.148.031-.15.03-.151.03-.153.029-.154.027-.156.027-.158.026-.159.025-.161.024-.162.023-.163.022-.165.021-.166.02-.167.019-.169.018-.169.017-.171.016-.173.015-.173.014-.175.013-.175.012-.177.011-.178.01-.179.008-.179.008-.181.006-.182.005-.182.004-.184.003-.184.002h-.37l-.184-.002-.184-.003-.182-.004-.182-.005-.181-.006-.179-.008-.179-.008-.178-.01-.176-.011-.176-.012-.175-.013-.173-.014-.172-.015-.171-.016-.17-.017-.169-.018-.167-.019-.166-.02-.165-.021-.163-.022-.162-.023-.161-.024-.159-.025-.157-.026-.156-.027-.155-.027-.153-.029-.151-.03-.15-.03-.148-.031-.146-.032-.145-.033-.143-.034-.141-.035-.14-.035-.137-.037-.136-.037-.134-.038-.132-.038-.13-.04-.128-.04-.126-.041-.124-.042-.122-.042-.12-.044-.117-.043-.116-.045-.113-.045-.112-.046-.109-.047-.106-.047-.105-.048-.102-.049-.1-.049-.097-.05-.095-.05-.093-.052-.09-.051-.087-.052-.085-.053-.083-.054-.08-.054-.077-.054v4.127zm0-5.654v.011l.001.021.003.021.004.021.005.022.006.022.007.022.009.022.01.022.011.023.012.023.013.023.015.024.016.023.017.024.018.024.019.024.021.024.022.024.023.025.024.024.052.05.056.05.061.05.066.051.07.051.075.052.079.051.084.052.088.052.092.052.097.052.102.052.105.052.11.051.114.051.119.052.123.05.127.051.131.05.135.049.139.049.144.048.147.048.152.047.155.046.16.045.163.045.167.044.171.042.176.042.178.04.183.04.187.038.19.037.194.036.197.034.202.033.204.032.209.03.212.028.216.027.219.025.222.024.226.022.23.02.233.018.236.016.24.014.243.012.246.01.249.008.253.006.256.003.259.001.26-.001.257-.003.254-.006.25-.008.247-.01.244-.012.241-.015.237-.016.233-.018.231-.02.226-.022.224-.024.22-.025.216-.027.212-.029.21-.03.205-.032.202-.033.198-.035.194-.036.191-.037.187-.039.183-.039.179-.041.175-.042.172-.043.168-.044.163-.045.16-.045.155-.047.152-.047.148-.048.143-.048.139-.05.136-.049.131-.05.126-.051.123-.051.118-.051.114-.052.11-.052.106-.052.101-.052.096-.052.092-.052.088-.052.083-.052.079-.052.074-.051.07-.052.065-.051.06-.05.056-.051.051-.049.023-.025.023-.024.021-.025.02-.024.019-.024.018-.024.017-.024.015-.023.014-.023.013-.024.012-.022.01-.023.01-.023.008-.022.006-.022.006-.022.004-.021.004-.022.001-.021.001-.021v-4.139l-.077.054-.08.054-.083.054-.085.052-.087.053-.09.051-.093.051-.095.051-.097.05-.1.049-.102.049-.105.048-.106.047-.109.047-.111.046-.114.045-.115.044-.118.044-.12.044-.122.042-.124.042-.126.041-.128.04-.13.039-.132.039-.134.038-.135.037-.138.036-.139.036-.142.035-.143.033-.144.033-.147.033-.148.031-.15.03-.151.03-.153.028-.154.028-.156.027-.158.026-.159.025-.161.024-.162.023-.163.022-.165.021-.166.02-.167.019-.169.018-.169.017-.171.016-.173.015-.173.014-.175.013-.175.012-.177.011-.178.009-.179.009-.179.007-.181.007-.182.005-.182.004-.184.003-.184.002h-.37l-.184-.002-.184-.003-.182-.004-.182-.005-.181-.007-.179-.007-.179-.009-.178-.009-.176-.011-.176-.012-.175-.013-.173-.014-.172-.015-.171-.016-.17-.017-.169-.018-.167-.019-.166-.02-.165-.021-.163-.022-.162-.023-.161-.024-.159-.025-.157-.026-.156-.027-.155-.028-.153-.028-.151-.03-.15-.03-.148-.031-.146-.033-.145-.033-.143-.033-.141-.035-.14-.036-.137-.036-.136-.037-.134-.038-.132-.039-.13-.039-.128-.04-.126-.041-.124-.042-.122-.043-.12-.043-.117-.044-.116-.044-.113-.046-.112-.046-.109-.046-.106-.047-.105-.048-.102-.049-.1-.049-.097-.05-.095-.051-.093-.051-.09-.051-.087-.053-.085-.052-.083-.054-.08-.054-.077-.054v4.139zm0-5.666v.011l.001.02.003.022.004.021.005.022.006.021.007.022.009.023.01.022.011.023.012.023.013.023.015.023.016.024.017.024.018.023.019.024.021.025.022.024.023.024.024.025.052.05.056.05.061.05.066.051.07.051.075.052.079.051.084.052.088.052.092.052.097.052.102.052.105.051.11.052.114.051.119.051.123.051.127.05.131.05.135.05.139.049.144.048.147.048.152.047.155.046.16.045.163.045.167.043.171.043.176.042.178.04.183.04.187.038.19.037.194.036.197.034.202.033.204.032.209.03.212.028.216.027.219.025.222.024.226.021.23.02.233.018.236.017.24.014.243.012.246.01.249.008.253.006.256.003.259.001.26-.001.257-.003.254-.006.25-.008.247-.01.244-.013.241-.014.237-.016.233-.018.231-.02.226-.022.224-.024.22-.025.216-.027.212-.029.21-.03.205-.032.202-.033.198-.035.194-.036.191-.037.187-.039.183-.039.179-.041.175-.042.172-.043.168-.044.163-.045.16-.045.155-.047.152-.047.148-.048.143-.049.139-.049.136-.049.131-.051.126-.05.123-.051.118-.052.114-.051.11-.052.106-.052.101-.052.096-.052.092-.052.088-.052.083-.052.079-.052.074-.052.07-.051.065-.051.06-.051.056-.05.051-.049.023-.025.023-.025.021-.024.02-.024.019-.024.018-.024.017-.024.015-.023.014-.024.013-.023.012-.023.01-.022.01-.023.008-.022.006-.022.006-.022.004-.022.004-.021.001-.021.001-.021v-4.153l-.077.054-.08.054-.083.053-.085.053-.087.053-.09.051-.093.051-.095.051-.097.05-.1.049-.102.048-.105.048-.106.048-.109.046-.111.046-.114.046-.115.044-.118.044-.12.043-.122.043-.124.042-.126.041-.128.04-.13.039-.132.039-.134.038-.135.037-.138.036-.139.036-.142.034-.143.034-.144.033-.147.032-.148.032-.15.03-.151.03-.153.028-.154.028-.156.027-.158.026-.159.024-.161.024-.162.023-.163.023-.165.021-.166.02-.167.019-.169.018-.169.017-.171.016-.173.015-.173.014-.175.013-.175.012-.177.01-.178.01-.179.009-.179.007-.181.006-.182.006-.182.004-.184.003-.184.001-.185.001-.185-.001-.184-.001-.184-.003-.182-.004-.182-.006-.181-.006-.179-.007-.179-.009-.178-.01-.176-.01-.176-.012-.175-.013-.173-.014-.172-.015-.171-.016-.17-.017-.169-.018-.167-.019-.166-.02-.165-.021-.163-.023-.162-.023-.161-.024-.159-.024-.157-.026-.156-.027-.155-.028-.153-.028-.151-.03-.15-.03-.148-.032-.146-.032-.145-.033-.143-.034-.141-.034-.14-.036-.137-.036-.136-.037-.134-.038-.132-.039-.13-.039-.128-.041-.126-.041-.124-.041-.122-.043-.12-.043-.117-.044-.116-.044-.113-.046-.112-.046-.109-.046-.106-.048-.105-.048-.102-.048-.1-.05-.097-.049-.095-.051-.093-.051-.09-.052-.087-.052-.085-.053-.083-.053-.08-.054-.077-.054v4.153zm8.74-8.179l-.257.004-.254.005-.25.008-.247.011-.244.012-.241.014-.237.016-.233.018-.231.021-.226.022-.224.023-.22.026-.216.027-.212.028-.21.031-.205.032-.202.033-.198.034-.194.036-.191.038-.187.038-.183.04-.179.041-.175.042-.172.043-.168.043-.163.045-.16.046-.155.046-.152.048-.148.048-.143.048-.139.049-.136.05-.131.05-.126.051-.123.051-.118.051-.114.052-.11.052-.106.052-.101.052-.096.052-.092.052-.088.052-.083.052-.079.052-.074.051-.07.052-.065.051-.06.05-.056.05-.051.05-.023.025-.023.024-.021.024-.02.025-.019.024-.018.024-.017.023-.015.024-.014.023-.013.023-.012.023-.01.023-.01.022-.008.022-.006.023-.006.021-.004.022-.004.021-.001.021-.001.021.001.021.001.021.004.021.004.022.006.021.006.023.008.022.01.022.01.023.012.023.013.023.014.023.015.024.017.023.018.024.019.024.02.025.021.024.023.024.023.025.051.05.056.05.06.05.065.051.07.052.074.051.079.052.083.052.088.052.092.052.096.052.101.052.106.052.11.052.114.052.118.051.123.051.126.051.131.05.136.05.139.049.143.048.148.048.152.048.155.046.16.046.163.045.168.043.172.043.175.042.179.041.183.04.187.038.191.038.194.036.198.034.202.033.205.032.21.031.212.028.216.027.22.026.224.023.226.022.231.021.233.018.237.016.241.014.244.012.247.011.25.008.254.005.257.004.26.001.26-.001.257-.004.254-.005.25-.008.247-.011.244-.012.241-.014.237-.016.233-.018.231-.021.226-.022.224-.023.22-.026.216-.027.212-.028.21-.031.205-.032.202-.033.198-.034.194-.036.191-.038.187-.038.183-.04.179-.041.175-.042.172-.043.168-.043.163-.045.16-.046.155-.046.152-.048.148-.048.143-.048.139-.049.136-.05.131-.05.126-.051.123-.051.118-.051.114-.052.11-.052.106-.052.101-.052.096-.052.092-.052.088-.052.083-.052.079-.052.074-.051.07-.052.065-.051.06-.05.056-.05.051-.05.023-.025.023-.024.021-.024.02-.025.019-.024.018-.024.017-.023.015-.024.014-.023.013-.023.012-.023.01-.023.01-.022.008-.022.006-.023.006-.021.004-.022.004-.021.001-.021.001-.021-.001-.021-.001-.021-.004-.021-.004-.022-.006-.021-.006-.023-.008-.022-.01-.022-.01-.023-.012-.023-.013-.023-.014-.023-.015-.024-.017-.023-.018-.024-.019-.024-.02-.025-.021-.024-.023-.024-.023-.025-.051-.05-.056-.05-.06-.05-.065-.051-.07-.052-.074-.051-.079-.052-.083-.052-.088-.052-.092-.052-.096-.052-.101-.052-.106-.052-.11-.052-.114-.052-.118-.051-.123-.051-.126-.051-.131-.05-.136-.05-.139-.049-.143-.048-.148-.048-.152-.048-.155-.046-.16-.046-.163-.045-.168-.043-.172-.043-.175-.042-.179-.041-.183-.04-.187-.038-.191-.038-.194-.036-.198-.034-.202-.033-.205-.032-.21-.031-.212-.028-.216-.027-.22-.026-.224-.023-.226-.022-.231-.021-.233-.018-.237-.016-.241-.014-.244-.012-.247-.011-.25-.008-.254-.005-.257-.004-.26-.001-.26.001z")},"insertDatabaseIcon"),Yr=x(function(e,t){e.append("defs").append("symbol").attr("id",t+"-computer").attr("width","24").attr("height","24").append("path").attr("transform","scale(.5)").attr("d","M2 2v13h20v-13h-20zm18 11h-16v-9h16v9zm-10.228 6l.466-1h3.524l.467 1h-4.457zm14.228 3h-24l2-6h2.104l-1.33 4h18.45l-1.297-4h2.073l2 6zm-5-10h-14v-7h14v7z")},"insertComputerIcon"),Wr=x(function(e,t){e.append("defs").append("symbol").attr("id",t+"-clock").attr("width","24").attr("height","24").append("path").attr("transform","scale(.5)").attr("d","M12 2c5.514 0 10 4.486 10 10s-4.486 10-10 10-10-4.486-10-10 4.486-10 10-10zm0-2c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm5.848 12.459c.202.038.202.333.001.372-1.907.361-6.045 1.111-6.547 1.111-.719 0-1.301-.582-1.301-1.301 0-.512.77-5.447 1.125-7.445.034-.192.312-.181.343.014l.985 6.238 5.394 1.011z")},"insertClockIcon"),Kr=x(function(e,t){e.append("defs").append("marker").attr("id",t+"-arrowhead").attr("refX",7.9).attr("refY",5).attr("markerUnits","userSpaceOnUse").attr("markerWidth",12).attr("markerHeight",12).attr("orient","auto-start-reverse").append("path").attr("d","M -1 0 L 10 5 L 0 10 z")},"insertArrowHead"),Fr=x(function(e,t){e.append("defs").append("marker").attr("id",t+"-filled-head").attr("refX",15.5).attr("refY",7).attr("markerWidth",20).attr("markerHeight",28).attr("orient","auto").append("path").attr("d","M 18,7 L9,13 L14,7 L9,1 Z")},"insertArrowFilledHead"),Hr=x(function(e,t){e.append("defs").append("marker").attr("id",t+"-sequencenumber").attr("refX",15).attr("refY",15).attr("markerWidth",60).attr("markerHeight",40).attr("orient","auto").append("circle").attr("cx",15).attr("cy",15).attr("r",6)},"insertSequenceNumber"),qr=x(function(e,t){e.append("defs").append("marker").attr("id",t+"-crosshead").attr("markerWidth",15).attr("markerHeight",8).attr("orient","auto").attr("refX",4).attr("refY",4.5).append("path").attr("fill","none").attr("stroke","#000000").style("stroke-dasharray","0, 0").attr("stroke-width","1pt").attr("d","M 1,2 L 6,7 M 6,2 L 1,7")},"insertArrowCrossHead"),zr=x(function(e,t){const{theme:a}=t;e.append("defs").append("filter").attr("id","drop-shadow").attr("height","130%").attr("width","130%").append("feDropShadow").attr("dx","4").attr("dy","4").attr("stdDeviation",0).attr("flood-opacity","0.06").attr("flood-color",`${a==="redux"||a==="redux-color"?"#000000":"#FFFFFF"}`)},"insertDropShadow"),Fe=x(function(){return{x:0,y:0,fill:void 0,anchor:void 0,style:"#666",width:void 0,height:void 0,textMargin:0,rx:0,ry:0,tspan:!0,valign:void 0}},"getTextObj"),Ur=x(function(){return{x:0,y:0,fill:"#EDF2AE",stroke:"#666",width:100,anchor:"start",height:100,rx:0,ry:0}},"getNoteRect"),Et=(function(){function e(n,s,o,E,h,p,_){const u=s.append("text").attr("x",o+h/2).attr("y",E+p/2+5).style("text-anchor","middle").text(n);i(u,_)}x(e,"byText");function t(n,s,o,E,h,p,_,u){const{actorFontSize:O,actorFontFamily:T,actorFontWeight:g}=u,[f,I]=Be(O),L=n.split(m.lineBreakRegex);for(let b=0;b<L.length;b++){const P=b*f-f*(L.length-1)/2,S=s.append("text").attr("x",o+h/2).attr("y",E).style("text-anchor","middle").style("font-size",I).style("font-weight",g).style("font-family",T);S.append("tspan").attr("x",o+h/2).attr("dy",P).text(L[b]),S.attr("y",E+p/2).attr("dominant-baseline","central").attr("alignment-baseline","central"),i(S,_)}}x(t,"byTspan");function a(n,s,o,E,h,p,_,u){const O=s.append("switch"),g=O.append("foreignObject").attr("x",o).attr("y",E).attr("width",h).attr("height",p).append("xhtml:div").style("display","table").style("height","100%").style("width","100%");g.append("div").style("display","table-cell").style("text-align","center").style("vertical-align","middle").text(n),t(n,O,o,E,h,p,_,u),i(g,_)}x(a,"byFo");async function r(n,s,o,E,h,p,_,u){const O=await kt(n,Ft()),T=s.append("switch"),f=T.append("foreignObject").attr("x",o+h/2-O.width/2).attr("y",E+p/2-O.height/2).attr("width",O.width).attr("height",O.height).append("xhtml:div").style("height","100%").style("width","100%");f.append("div").style("text-align","center").style("vertical-align","middle").html(await Ve(n,Ft())),t(n,T,o,E,h,p,_,u),i(f,_)}x(r,"byKatex");function i(n,s){for(const o in s)s.hasOwnProperty(o)&&n.attr(o,s[o])}return x(i,"_setTextAttrs"),function(n,s=!1){return s?r:n.textPlacement==="fo"?a:n.textPlacement==="old"?e:t}})(),Gr=(function(){function e(i,n,s,o,E,h,p){const _=n.append("text").attr("x",s).attr("y",o).style("text-anchor","start").text(i);r(_,p)}x(e,"byText");function t(i,n,s,o,E,h,p,_){const{actorFontSize:u,actorFontFamily:O,actorFontWeight:T}=_,g=i.split(m.lineBreakRegex);for(let f=0;f<g.length;f++){const I=f*u-u*(g.length-1)/2,L=n.append("text").attr("x",s).attr("y",o).style("text-anchor","start").style("font-size",u).style("font-weight",T).style("font-family",O);L.append("tspan").attr("x",s).attr("dy",I).text(g[f]),L.attr("y",o+h/2).attr("dominant-baseline","central").attr("alignment-baseline","central"),r(L,p)}}x(t,"byTspan");function a(i,n,s,o,E,h,p,_){const u=n.append("switch"),T=u.append("foreignObject").attr("x",s).attr("y",o).attr("width",E).attr("height",h).append("xhtml:div").style("display","table").style("height","100%").style("width","100%");T.append("div").style("display","table-cell").style("text-align","center").style("vertical-align","middle").text(i),t(i,u,s,o,E,h,p,_),r(T,p)}x(a,"byFo");function r(i,n){for(const s in n)n.hasOwnProperty(s)&&i.attr(s,n[s])}return x(r,"_setTextAttrs"),function(i){return i.textPlacement==="fo"?a:i.textPlacement==="old"?e:t}})(),Xr=x(function(e,t){e.append("defs").append("marker").attr("id",t+"-solidTopArrowHead").attr("refX",7.9).attr("refY",7.25).attr("markerUnits","userSpaceOnUse").attr("markerWidth",12).attr("markerHeight",12).attr("orient","auto-start-reverse").append("path").attr("d","M 0 0 L 10 8 L 0 8 z")},"insertSolidTopArrowHead"),Jr=x(function(e,t){e.append("defs").append("marker").attr("id",t+"-solidBottomArrowHead").attr("refX",7.9).attr("refY",.75).attr("markerUnits","userSpaceOnUse").attr("markerWidth",12).attr("markerHeight",12).attr("orient","auto-start-reverse").append("path").attr("d","M 0 0 L 10 0 L 0 8 z")},"insertSolidBottomArrowHead"),Zr=x(function(e,t){e.append("defs").append("marker").attr("id",t+"-stickTopArrowHead").attr("refX",7.5).attr("refY",7).attr("markerUnits","userSpaceOnUse").attr("markerWidth",12).attr("markerHeight",12).attr("orient","auto-start-reverse").append("path").attr("d","M 0 0 L 7 7").attr("stroke","black").attr("stroke-width",1.5).attr("fill","none")},"insertStickTopArrowHead"),Qr=x(function(e,t){e.append("defs").append("marker").attr("id",t+"-stickBottomArrowHead").attr("refX",7.5).attr("refY",0).attr("markerUnits","userSpaceOnUse").attr("markerWidth",12).attr("markerHeight",12).attr("orient","auto-start-reverse").append("path").attr("d","M 0 7 L 7 0").attr("stroke","black").attr("stroke-width",1.5).attr("fill","none")},"insertStickBottomArrowHead"),q={drawRect:Pt,drawText:St,drawLabel:Ye,drawActor:Dr,drawBox:vr,drawPopup:Lr,anchorElement:Cr,drawActivation:Mr,drawLoop:Br,drawBackgroundRect:Ke,insertArrowHead:Kr,insertArrowFilledHead:Fr,insertSequenceNumber:Hr,insertArrowCrossHead:qr,insertDatabaseIcon:Vr,insertComputerIcon:Yr,insertClockIcon:Wr,getTextObj:Fe,getNoteRect:Ur,fixLifeLineHeights:We,sanitizeUrl:Me.sanitizeUrl,insertDropShadow:zr,insertSolidTopArrowHead:Xr,insertSolidBottomArrowHead:Jr,insertStickTopArrowHead:Zr,insertStickBottomArrowHead:Qr},l={},R={data:{startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},verticalPos:0,sequenceItems:[],activations:[],models:{getHeight:x(function(){return Math.max.apply(null,this.actors.length===0?[0]:this.actors.map(e=>e.height||0))+(this.loops.length===0?0:this.loops.map(e=>e.height||0).reduce((e,t)=>e+t))+(this.messages.length===0?0:this.messages.map(e=>e.height||0).reduce((e,t)=>e+t))+(this.notes.length===0?0:this.notes.map(e=>e.height||0).reduce((e,t)=>e+t))},"getHeight"),clear:x(function(){this.actors=[],this.boxes=[],this.loops=[],this.messages=[],this.notes=[]},"clear"),addBox:x(function(e){this.boxes.push(e)},"addBox"),addActor:x(function(e){this.actors.push(e)},"addActor"),addLoop:x(function(e){this.loops.push(e)},"addLoop"),addMessage:x(function(e){this.messages.push(e)},"addMessage"),addNote:x(function(e){this.notes.push(e)},"addNote"),lastActor:x(function(){return this.actors[this.actors.length-1]},"lastActor"),lastLoop:x(function(){return this.loops[this.loops.length-1]},"lastLoop"),lastMessage:x(function(){return this.messages[this.messages.length-1]},"lastMessage"),lastNote:x(function(){return this.notes[this.notes.length-1]},"lastNote"),actors:[],boxes:[],loops:[],messages:[],notes:[]},init:x(function(){this.sequenceItems=[],this.activations=[],this.models.clear(),this.data={startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},this.verticalPos=0,ze(j())},"init"),updateVal:x(function(e,t,a,r){e[t]===void 0?e[t]=a:e[t]=r(a,e[t])},"updateVal"),updateBounds:x(function(e,t,a,r){const i=this;let n=0;function s(o){return x(function(h){n++;const p=i.sequenceItems.length-n+1;i.updateVal(h,"starty",t-p*l.boxMargin,Math.min),i.updateVal(h,"stopy",r+p*l.boxMargin,Math.max),i.updateVal(R.data,"startx",e-p*l.boxMargin,Math.min),i.updateVal(R.data,"stopx",a+p*l.boxMargin,Math.max),o!=="activation"&&(i.updateVal(h,"startx",e-p*l.boxMargin,Math.min),i.updateVal(h,"stopx",a+p*l.boxMargin,Math.max),i.updateVal(R.data,"starty",t-p*l.boxMargin,Math.min),i.updateVal(R.data,"stopy",r+p*l.boxMargin,Math.max))},"updateItemBounds")}x(s,"updateFn"),this.sequenceItems.forEach(s()),this.activations.forEach(s("activation"))},"updateBounds"),insert:x(function(e,t,a,r){const i=m.getMin(e,a),n=m.getMax(e,a),s=m.getMin(t,r),o=m.getMax(t,r);this.updateVal(R.data,"startx",i,Math.min),this.updateVal(R.data,"starty",s,Math.min),this.updateVal(R.data,"stopx",n,Math.max),this.updateVal(R.data,"stopy",o,Math.max),this.updateBounds(i,s,n,o)},"insert"),newActivation:x(function(e,t,a){const r=a.get(e.from),i=Ut(e.from).length||0,n=r.x+r.width/2+(i-1)*l.activationWidth/2;this.activations.push({startx:n,starty:this.verticalPos+2,stopx:n+l.activationWidth,stopy:void 0,actor:e.from,anchored:q.anchorElement(t)})},"newActivation"),endActivation:x(function(e){const t=this.activations.map(function(a){return a.actor}).lastIndexOf(e.from);return this.activations.splice(t,1)[0]},"endActivation"),createLoop:x(function(e={message:void 0,wrap:!1,width:void 0},t){return{startx:void 0,starty:this.verticalPos,stopx:void 0,stopy:void 0,title:e.message,wrap:e.wrap,width:e.width,height:0,fill:t}},"createLoop"),newLoop:x(function(e={message:void 0,wrap:!1,width:void 0},t){this.sequenceItems.push(this.createLoop(e,t))},"newLoop"),endLoop:x(function(){return this.sequenceItems.pop()},"endLoop"),isLoopOverlap:x(function(){return this.sequenceItems.length?this.sequenceItems[this.sequenceItems.length-1].overlap:!1},"isLoopOverlap"),addSectionToLoop:x(function(e){const t=this.sequenceItems.pop();t.sections=t.sections||[],t.sectionTitles=t.sectionTitles||[],t.sections.push({y:R.getVerticalPos(),height:0}),t.sectionTitles.push(e),this.sequenceItems.push(t)},"addSectionToLoop"),saveVerticalPos:x(function(){this.isLoopOverlap()&&(this.savedVerticalPos=this.verticalPos)},"saveVerticalPos"),resetVerticalPos:x(function(){this.isLoopOverlap()&&(this.verticalPos=this.savedVerticalPos)},"resetVerticalPos"),bumpVerticalPos:x(function(e){this.verticalPos=this.verticalPos+e,this.data.stopy=m.getMax(this.data.stopy,this.verticalPos)},"bumpVerticalPos"),getVerticalPos:x(function(){return this.verticalPos},"getVerticalPos"),getBounds:x(function(){return{bounds:this.data,models:this.models}},"getBounds")},$r=x(async function(e,t,a){R.bumpVerticalPos(l.boxMargin),t.height=l.boxMargin,t.starty=R.getVerticalPos();const r=dt();r.x=t.startx,r.y=t.starty,r.width=t.width||l.width,r.class="note";const i=e.append("g");i.attr("data-et","note"),i.attr("data-id","i"+a);const n=q.drawRect(i,r),s=se();s.x=t.startx,s.y=t.starty,s.width=r.width,s.dy="1em",s.text=t.message,s.class="noteText",s.fontFamily=l.noteFontFamily,s.fontSize=l.noteFontSize,s.fontWeight=l.noteFontWeight,s.anchor=l.noteAlign,s.textMargin=l.noteMargin,s.valign="center";const o=Q(s.text)?await Ht(i,s):St(i,s),E=Math.round(o.map(h=>(h._groups||h)[0][0].getBBox().height).reduce((h,p)=>h+p));n.attr("height",E+2*l.noteMargin),t.height+=E+2*l.noteMargin,R.bumpVerticalPos(E+2*l.noteMargin),t.stopy=t.starty+E+2*l.noteMargin,t.stopx=t.startx+r.width,R.insert(t.startx,t.starty,t.stopx,t.stopy),R.models.addNote(t)},"drawNote"),ve=x(function(e,t,a,r,i,n,s){const o=r.db.getActors(),E=o.get(t.from),h=o.get(t.to),p=a.sequenceVisible;let _=E.x+E.width/2,u=h.x+h.width/2;const O=_<=u,T=Je(t,r),g=e.append("g"),f=16.5,I=x((w,M)=>{const V=w?f:-f;return M?-V:V},"getCircleOffset"),L=x(w=>{g.append("circle").attr("cx",w).attr("cy",s).attr("r",5).attr("width",10).attr("height",10)},"drawCircle"),{CENTRAL_CONNECTION:b,CENTRAL_CONNECTION_REVERSE:P,CENTRAL_CONNECTION_DUAL:S}=r.db.LINETYPE;if(p)switch(t.centralConnection){case b:T&&(u+=I(O,!0));break;case P:T||(_+=I(O,!1));break;case S:T?u+=I(O,!0):_+=I(O,!1);break}switch(t.centralConnection){case b:L(u);break;case P:L(_);break;case S:L(_),L(u);break}},"drawCentralConnection"),Rt=x(e=>({fontFamily:e.messageFontFamily,fontSize:e.messageFontSize,fontWeight:e.messageFontWeight}),"messageFont"),bt=x(e=>({fontFamily:e.noteFontFamily,fontSize:e.noteFontSize,fontWeight:e.noteFontWeight}),"noteFont"),re=x(e=>({fontFamily:e.actorFontFamily,fontSize:e.actorFontSize,fontWeight:e.actorFontWeight}),"actorFont");async function He(e,t){R.bumpVerticalPos(10);const{startx:a,stopx:r,message:i}=t,n=m.splitBreaks(i).length,s=Q(i),o=s?await kt(i,j()):Z.calculateTextDimensions(i,Rt(l));if(!s){const _=o.height/n;t.height+=_,R.bumpVerticalPos(_)}let E,h=o.height-10;const p=o.width;if(a===r){E=R.getVerticalPos()+h,l.rightAngles||(h+=l.boxMargin,E=R.getVerticalPos()+h),h+=30;const _=m.getMax(p/2,l.width/2);R.insert(a-_,R.getVerticalPos()-10+h,r+_,R.getVerticalPos()+30+h)}else h+=l.boxMargin,E=R.getVerticalPos()+h,R.insert(a,E-10,r,E);return R.bumpVerticalPos(h),t.height+=h,t.stopy=t.starty+t.height,R.insert(t.fromBounds,t.starty,t.toBounds,t.stopy),E}x(He,"boundMessage");var jr=x(async function(e,t,a,r,i,n){const{startx:s,stopx:o,starty:E,message:h,type:p,sequenceIndex:_,sequenceVisible:u}=t,O=Z.calculateTextDimensions(h,Rt(l)),T=se();T.x=Math.min(s,o),T.y=E+10,T.width=Math.abs(o-s),T.class="messageText",T.dy="1em",T.text=h,T.fontFamily=l.messageFontFamily,T.fontSize=l.messageFontSize,T.fontWeight=l.messageFontWeight,T.anchor=l.messageAlign,T.valign="center",T.textMargin=l.wrapPadding,T.tspan=!1,Q(T.text)?await Ht(e,T,{startx:s,stopx:o,starty:a}):St(e,T);const g=O.width;let f;if(s===o){const L=u||l.showSequenceNumbers,b=Je(i,r),P=na(i,r),S=s+(L&&(b||P)?10:0);l.rightAngles?f=e.append("path").attr("d",`M  ${S},${a} H ${s+m.getMax(l.width/2,g/2)} V ${a+25} H ${s}`):f=e.append("path").attr("d","M "+S+","+a+" C "+(S+60)+","+(a-10)+" "+(s+60)+","+(a+30)+" "+s+","+(a+20)),te(i,r)&&ve(e,i,t,r,s,o,a)}else f=e.append("line"),f.attr("x1",s),f.attr("y1",a),f.attr("x2",o),f.attr("y2",a),te(i,r)&&ve(e,i,t,r,s,o,a);p===r.db.LINETYPE.DOTTED||p===r.db.LINETYPE.DOTTED_CROSS||p===r.db.LINETYPE.DOTTED_POINT||p===r.db.LINETYPE.DOTTED_OPEN||p===r.db.LINETYPE.BIDIRECTIONAL_DOTTED||p===r.db.LINETYPE.SOLID_TOP_DOTTED||p===r.db.LINETYPE.SOLID_BOTTOM_DOTTED||p===r.db.LINETYPE.STICK_TOP_DOTTED||p===r.db.LINETYPE.STICK_BOTTOM_DOTTED||p===r.db.LINETYPE.SOLID_ARROW_TOP_REVERSE_DOTTED||p===r.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE_DOTTED||p===r.db.LINETYPE.STICK_ARROW_TOP_REVERSE_DOTTED||p===r.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE_DOTTED?(f.style("stroke-dasharray","3, 3"),f.attr("class","messageLine1")):f.attr("class","messageLine0"),f.attr("data-et","message"),f.attr("data-id","i"+t.id),f.attr("data-from",t.from),f.attr("data-to",t.to);let I="";if(l.arrowMarkerAbsolute&&(I=Er(!0)),f.attr("stroke-width",2),f.attr("stroke","none"),f.style("fill","none"),(p===r.db.LINETYPE.SOLID_TOP||p===r.db.LINETYPE.SOLID_TOP_DOTTED)&&f.attr("marker-end","url("+I+"#"+n+"-solidTopArrowHead)"),(p===r.db.LINETYPE.SOLID_BOTTOM||p===r.db.LINETYPE.SOLID_BOTTOM_DOTTED)&&f.attr("marker-end","url("+I+"#"+n+"-solidBottomArrowHead)"),(p===r.db.LINETYPE.STICK_TOP||p===r.db.LINETYPE.STICK_TOP_DOTTED)&&f.attr("marker-end","url("+I+"#"+n+"-stickTopArrowHead)"),(p===r.db.LINETYPE.STICK_BOTTOM||p===r.db.LINETYPE.STICK_BOTTOM_DOTTED)&&f.attr("marker-end","url("+I+"#"+n+"-stickBottomArrowHead)"),(p===r.db.LINETYPE.SOLID_ARROW_TOP_REVERSE||p===r.db.LINETYPE.SOLID_ARROW_TOP_REVERSE_DOTTED)&&f.attr("marker-start","url("+I+"#"+n+"-solidBottomArrowHead)"),(p===r.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE||p===r.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE_DOTTED)&&f.attr("marker-start","url("+I+"#"+n+"-solidTopArrowHead)"),(p===r.db.LINETYPE.STICK_ARROW_TOP_REVERSE||p===r.db.LINETYPE.STICK_ARROW_TOP_REVERSE_DOTTED)&&f.attr("marker-start","url("+I+"#"+n+"-stickBottomArrowHead)"),(p===r.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE||p===r.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE_DOTTED)&&f.attr("marker-start","url("+I+"#"+n+"-stickTopArrowHead)"),(p===r.db.LINETYPE.SOLID||p===r.db.LINETYPE.DOTTED)&&f.attr("marker-end","url("+I+"#"+n+"-arrowhead)"),(p===r.db.LINETYPE.BIDIRECTIONAL_SOLID||p===r.db.LINETYPE.BIDIRECTIONAL_DOTTED)&&(f.attr("marker-start","url("+I+"#"+n+"-arrowhead)"),f.attr("marker-end","url("+I+"#"+n+"-arrowhead)")),(p===r.db.LINETYPE.SOLID_POINT||p===r.db.LINETYPE.DOTTED_POINT)&&f.attr("marker-end","url("+I+"#"+n+"-filled-head)"),(p===r.db.LINETYPE.SOLID_CROSS||p===r.db.LINETYPE.DOTTED_CROSS)&&f.attr("marker-end","url("+I+"#"+n+"-crosshead)"),u||l.showSequenceNumbers){const L=p===r.db.LINETYPE.BIDIRECTIONAL_SOLID||p===r.db.LINETYPE.BIDIRECTIONAL_DOTTED,b=p===r.db.LINETYPE.SOLID_ARROW_TOP_REVERSE||p===r.db.LINETYPE.SOLID_ARROW_TOP_REVERSE_DOTTED||p===r.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE||p===r.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE_DOTTED||p===r.db.LINETYPE.STICK_ARROW_TOP_REVERSE||p===r.db.LINETYPE.STICK_ARROW_TOP_REVERSE_DOTTED||p===r.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE||p===r.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE_DOTTED,P=6,S=te(i,r);let w=s,M=o;L?(s<o?w=s+P*2:(w=s-P+(S?-5:0),w+=(i==null?void 0:i.centralConnection)===r.db.LINETYPE.CENTRAL_CONNECTION_DUAL||(i==null?void 0:i.centralConnection)===r.db.LINETYPE.CENTRAL_CONNECTION_REVERSE?-7.5:0),f.attr("x1",w)):b?(o>s?M=o-2*P:(M=o-P,w+=(i==null?void 0:i.centralConnection)===r.db.LINETYPE.CENTRAL_CONNECTION_DUAL||(i==null?void 0:i.centralConnection)===r.db.LINETYPE.CENTRAL_CONNECTION_REVERSE?-7.5:0),M+=S?15:0,f.attr("x2",M),f.attr("x1",w)):f.attr("x1",s+P);let V=0;const Y=s===o,z=s<=o;Y?V=t.fromBounds+1:b?V=z?t.toBounds-1:t.fromBounds+1:V=z?t.fromBounds+1:t.toBounds-1;let K="12px";const X=_.toString().length;X>5?K="7px":X>3&&(K="9px"),e.append("line").attr("x1",V).attr("y1",a).attr("x2",V).attr("y2",a).attr("stroke-width",0).attr("marker-start","url("+I+"#"+n+"-sequencenumber)"),e.append("text").attr("x",V).attr("y",a+4).attr("font-family","sans-serif").attr("font-size",K).attr("text-anchor","middle").attr("class","sequenceNumber").text(_)}},"drawMessage"),ta=x(function(e,t,a,r,i,n,s){let o=0,E=0,h,p=0;for(const _ of r){const u=t.get(_),O=u.box;h&&h!=O&&(s||R.models.addBox(h),E+=l.boxMargin+h.margin),O&&O!=h&&(s||(O.x=o+E,O.y=i),E+=O.margin),u.width=m.getMax(u.width||l.width,l.width),u.height=m.getMax(u.height||l.height,l.height),u.margin=u.margin||l.actorMargin,p=m.getMax(p,u.height),a.get(u.name)&&(E+=u.width/2),u.x=o+E,u.starty=R.getVerticalPos(),R.insert(u.x,i,u.x+u.width,u.height),o+=u.width+E,u.box&&(u.box.width=o+O.margin-u.box.x),E=u.margin,h=u.box,R.models.addActor(u)}h&&!s&&R.models.addBox(h),R.bumpVerticalPos(p)},"addActorRenderingData"),ae=x(async function(e,t,a,r,i,n,s){if(r){let o=0;R.bumpVerticalPos(l.boxMargin*2);for(const E of a){const h=t.get(E);h.stopy||(h.stopy=R.getVerticalPos());const p=await q.drawActor(e,h,l,!0,i,n,s);o=m.getMax(o,p)}R.bumpVerticalPos(o+l.boxMargin)}else for(const o of a){const E=t.get(o);await q.drawActor(e,E,l,!1,i,n,s)}},"drawActors"),qe=x(function(e,t,a,r){let i=0,n=0;for(const s of a){const o=t.get(s),E=ra(o),h=q.drawPopup(e,o,E,l,l.forceMenus,r);h.height>i&&(i=h.height),h.width+o.x>n&&(n=h.width+o.x)}return{maxHeight:i,maxWidth:n}},"drawActorsPopup"),ze=x(function(e){sr(l,e),e.fontFamily&&(l.actorFontFamily=l.noteFontFamily=l.messageFontFamily=e.fontFamily),e.fontSize&&(l.actorFontSize=l.noteFontSize=l.messageFontSize=e.fontSize),e.fontWeight&&(l.actorFontWeight=l.noteFontWeight=l.messageFontWeight=e.fontWeight)},"setConf"),Ut=x(function(e){return R.activations.filter(function(t){return t.actor===e})},"actorActivations"),Ce=x(function(e,t){const a=t.get(e),r=Ut(e),i=r.reduce(function(s,o){return m.getMin(s,o.startx)},a.x+a.width/2-1),n=r.reduce(function(s,o){return m.getMax(s,o.stopx)},a.x+a.width/2+1);return[i,n]},"activationBounds");function ht(e,t,a,r,i){R.bumpVerticalPos(a);let n=r;if(t.id&&t.message&&e[t.id]){const s=e[t.id].width,o=Rt(l);t.message=Z.wrapLabel(`[${t.message}]`,s-2*l.wrapPadding,o),t.width=s,t.wrap=!0;const E=Z.calculateTextDimensions(t.message,o),h=m.getMax(E.height,l.labelBoxHeight);n=r+h,it.debug(`${h} - ${t.message}`)}i(t),R.bumpVerticalPos(n)}x(ht,"adjustLoopHeightForWrap");function Ue(e,t,a,r,i,n,s){function o(p,_){p.x<i.get(e.from).x?(R.insert(t.stopx-_,t.starty,t.startx,t.stopy+p.height/2+l.noteMargin),t.stopx=t.stopx+_):(R.insert(t.startx,t.starty,t.stopx+_,t.stopy+p.height/2+l.noteMargin),t.stopx=t.stopx-_)}x(o,"receiverAdjustment");function E(p,_){p.x<i.get(e.to).x?(R.insert(t.startx-_,t.starty,t.stopx,t.stopy+p.height/2+l.noteMargin),t.startx=t.startx+_):(R.insert(t.stopx,t.starty,t.startx+_,t.stopy+p.height/2+l.noteMargin),t.startx=t.startx-_)}x(E,"senderAdjustment");const h=[Kt.ACTOR,Kt.CONTROL,Kt.ENTITY,Kt.DATABASE];if(n.get(e.to)==r){const p=i.get(e.to),_=h.includes(p.type)?It/2+3:p.width/2+3;o(p,_),p.starty=a-p.height/2,R.bumpVerticalPos(p.height/2)}else if(s.get(e.from)==r){const p=i.get(e.from);if(l.mirrorActors){const _=h.includes(p.type)?It/2:p.width/2;E(p,_)}p.stopy=a-p.height/2,R.bumpVerticalPos(p.height/2)}else if(s.get(e.to)==r){const p=i.get(e.to);if(l.mirrorActors){const _=h.includes(p.type)?It/2+3:p.width/2+3;o(p,_)}p.stopy=a-p.height/2,R.bumpVerticalPos(p.height/2)}}x(Ue,"adjustCreatedDestroyedData");var ea=x(async function(e,t,a,r){const{securityLevel:i,sequence:n,look:s,themeVariables:o}=j();l=n;let E;i==="sandbox"&&(E=Yt("#i"+t));const h=i==="sandbox"?Yt(E.nodes()[0].contentDocument.body):Yt("body"),p=i==="sandbox"?E.nodes()[0].contentDocument:document;R.init(),it.debug(r.db);const _=i==="sandbox"?h.select(`[id="${t}"]`):Yt(`[id="${t}"]`),u=r.db.getActors(),O=r.db.getCreatedActors(),T=r.db.getDestroyedActors(),g=r.db.getBoxes();let f=r.db.getActorKeys();const I=r.db.getMessages(),L=r.db.getDiagramTitle(),b=r.db.hasAtLeastOneBox(),P=r.db.hasAtLeastOneBoxWithTitle(),S=await Ge(u,I,r);if(l.height=await Xe(u,S,g),q.insertComputerIcon(_,t),q.insertDatabaseIcon(_,t),q.insertClockIcon(_,t),b&&(R.bumpVerticalPos(l.boxMargin),P&&R.bumpVerticalPos(g[0].textMaxHeight)),l.hideUnusedParticipants===!0){const A=new Set;I.forEach(D=>{A.add(D.from),A.add(D.to)}),f=f.filter(D=>A.has(D))}const w=new Map(f.map((A,D)=>{var rt;return[((rt=u.get(A))==null?void 0:rt.name)??A,D]}));ta(_,u,O,f,0,I,!1);const M=await ca(I,u,S,r);q.insertArrowHead(_,t),q.insertArrowCrossHead(_,t),q.insertArrowFilledHead(_,t),q.insertSequenceNumber(_,t),q.insertSolidTopArrowHead(_,t),q.insertSolidBottomArrowHead(_,t),q.insertStickTopArrowHead(_,t),q.insertStickBottomArrowHead(_,t),s==="neo"&&q.insertDropShadow(_,l);function V(A,D){const rt=R.endActivation(A);rt.starty+18>D&&(rt.starty=D-6,D+=12),q.drawActivation(_,rt,D,l,Ut(A.from).length,r,w),R.insert(rt.startx,D-10,rt.stopx,D)}x(V,"activeEnd");let Y=1,z=1;const K=[],X=[];let $=0;for(const A of I){let D,rt,at;switch(A.type){case r.db.LINETYPE.NOTE:R.resetVerticalPos(),rt=A.noteModel,await $r(_,rt,A.id);break;case r.db.LINETYPE.ACTIVE_START:R.newActivation(A,_,u);break;case r.db.LINETYPE.CENTRAL_CONNECTION:R.newActivation(A,_,u);break;case r.db.LINETYPE.CENTRAL_CONNECTION_REVERSE:R.newActivation(A,_,u);break;case r.db.LINETYPE.ACTIVE_END:V(A,R.getVerticalPos());break;case r.db.LINETYPE.LOOP_START:ht(M,A,l.boxMargin,l.boxMargin+l.boxTextMargin,F=>R.newLoop(F));break;case r.db.LINETYPE.LOOP_END:D=R.endLoop(),await q.drawLoop(_,D,"loop",l,A),R.bumpVerticalPos(D.stopy-R.getVerticalPos()),R.models.addLoop(D);break;case r.db.LINETYPE.RECT_START:ht(M,A,l.boxMargin,l.boxMargin,F=>{let Ot=F.message;Ot||(Ot=(o==null?void 0:o.rectBkgColor)||(o==null?void 0:o.actorBkg)||"rgba(128, 128, 128, 0.5)"),R.newLoop(void 0,Ot)});break;case r.db.LINETYPE.RECT_END:D=R.endLoop(),X.push(D),R.models.addLoop(D),R.bumpVerticalPos(D.stopy-R.getVerticalPos());break;case r.db.LINETYPE.OPT_START:ht(M,A,l.boxMargin,l.boxMargin+l.boxTextMargin,F=>R.newLoop(F));break;case r.db.LINETYPE.OPT_END:D=R.endLoop(),await q.drawLoop(_,D,"opt",l,A),R.bumpVerticalPos(D.stopy-R.getVerticalPos()),R.models.addLoop(D);break;case r.db.LINETYPE.ALT_START:ht(M,A,l.boxMargin,l.boxMargin+l.boxTextMargin,F=>R.newLoop(F));break;case r.db.LINETYPE.ALT_ELSE:ht(M,A,l.boxMargin+l.boxTextMargin,l.boxMargin,F=>R.addSectionToLoop(F));break;case r.db.LINETYPE.ALT_END:D=R.endLoop(),await q.drawLoop(_,D,"alt",l,A),R.bumpVerticalPos(D.stopy-R.getVerticalPos()),R.models.addLoop(D);break;case r.db.LINETYPE.PAR_START:case r.db.LINETYPE.PAR_OVER_START:ht(M,A,l.boxMargin,l.boxMargin+l.boxTextMargin,F=>R.newLoop(F)),R.saveVerticalPos();break;case r.db.LINETYPE.PAR_AND:ht(M,A,l.boxMargin+l.boxTextMargin,l.boxMargin,F=>R.addSectionToLoop(F));break;case r.db.LINETYPE.PAR_END:D=R.endLoop(),await q.drawLoop(_,D,"par",l,A),R.bumpVerticalPos(D.stopy-R.getVerticalPos()),R.models.addLoop(D);break;case r.db.LINETYPE.AUTONUMBER:Y=A.message.start||Y,z=A.message.step||z,A.message.visible?r.db.enableSequenceNumbers():r.db.disableSequenceNumbers();break;case r.db.LINETYPE.CRITICAL_START:ht(M,A,l.boxMargin,l.boxMargin+l.boxTextMargin,F=>R.newLoop(F));break;case r.db.LINETYPE.CRITICAL_OPTION:ht(M,A,l.boxMargin+l.boxTextMargin,l.boxMargin,F=>R.addSectionToLoop(F));break;case r.db.LINETYPE.CRITICAL_END:D=R.endLoop(),await q.drawLoop(_,D,"critical",l,A),R.bumpVerticalPos(D.stopy-R.getVerticalPos()),R.models.addLoop(D);break;case r.db.LINETYPE.BREAK_START:ht(M,A,l.boxMargin,l.boxMargin+l.boxTextMargin,F=>R.newLoop(F));break;case r.db.LINETYPE.BREAK_END:D=R.endLoop(),await q.drawLoop(_,D,"break",l,A),R.bumpVerticalPos(D.stopy-R.getVerticalPos()),R.models.addLoop(D);break;default:try{at=A.msgModel,at.starty=R.getVerticalPos(),at.sequenceIndex=Y,at.sequenceVisible=r.db.showSequenceNumbers(),at.id=A.id,at.from=A.from,at.to=A.to;const F=await He(_,at);Ue(A,at,F,$,u,O,T),K.push({messageModel:at,lineStartY:F,msg:A}),R.models.addMessage(at)}catch(F){it.error("error while drawing message",F)}}[r.db.LINETYPE.SOLID_OPEN,r.db.LINETYPE.DOTTED_OPEN,r.db.LINETYPE.SOLID,r.db.LINETYPE.SOLID_TOP,r.db.LINETYPE.SOLID_BOTTOM,r.db.LINETYPE.STICK_TOP,r.db.LINETYPE.STICK_BOTTOM,r.db.LINETYPE.SOLID_TOP_DOTTED,r.db.LINETYPE.SOLID_BOTTOM_DOTTED,r.db.LINETYPE.STICK_TOP_DOTTED,r.db.LINETYPE.STICK_BOTTOM_DOTTED,r.db.LINETYPE.SOLID_ARROW_TOP_REVERSE,r.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE,r.db.LINETYPE.STICK_ARROW_TOP_REVERSE,r.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE,r.db.LINETYPE.SOLID_ARROW_TOP_REVERSE_DOTTED,r.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE_DOTTED,r.db.LINETYPE.STICK_ARROW_TOP_REVERSE_DOTTED,r.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE_DOTTED,r.db.LINETYPE.DOTTED,r.db.LINETYPE.SOLID_CROSS,r.db.LINETYPE.DOTTED_CROSS,r.db.LINETYPE.SOLID_POINT,r.db.LINETYPE.DOTTED_POINT,r.db.LINETYPE.BIDIRECTIONAL_SOLID,r.db.LINETYPE.BIDIRECTIONAL_DOTTED].includes(A.type)&&(Y=Math.round((Y+z)*100)/100),$++}it.debug("createdActors",O),it.debug("destroyedActors",T),await ae(_,u,f,!1,t,r,w);for(const A of K)await jr(_,A.messageModel,A.lineStartY,r,A.msg,t);l.mirrorActors&&await ae(_,u,f,!0,t,r,w),X.forEach(A=>q.drawBackgroundRect(_,A)),We(_,u,f,l);for(const A of R.models.boxes){A.height=R.getVerticalPos()-A.y,R.insert(A.x,A.y,A.x+A.width,A.height);const D=l.boxMargin*2;A.startx=A.x-D,A.starty=A.y-D*.25,A.stopx=A.startx+A.width+2*D,A.stopy=A.starty+A.height+D*.75,A.stroke="rgb(0,0,0, 0.5)",q.drawBox(_,A,l)}b&&R.bumpVerticalPos(l.boxMargin);const tt=qe(_,u,f,p),{bounds:U}=R.getBounds();U.startx===void 0&&(U.startx=0),U.starty===void 0&&(U.starty=0),U.stopx===void 0&&(U.stopx=0),U.stopy===void 0&&(U.stopy=0);let nt=U.stopy-U.starty;nt<tt.maxHeight&&(nt=tt.maxHeight);let et=nt+2*l.diagramMarginY;l.mirrorActors&&(et=et-l.boxMargin+l.bottomMarginAdj);let W=U.stopx-U.startx;W<tt.maxWidth&&(W=tt.maxWidth);const C=W+2*l.diagramMarginX;L&&_.append("text").text(L).attr("x",(U.stopx-U.startx)/2-2*l.diagramMarginX).attr("y",-25),ar(_,et,C,l.useMaxWidth);const wt=L?40:0,Dt=u.size&&s==="neo"?30:0;_.attr("viewBox",U.startx-l.diagramMarginX+" -"+(l.diagramMarginY+wt)+" "+C+" "+(et+wt+Dt)),it.debug("models:",R.models)},"draw");async function Ge(e,t,a){const r={};for(const i of t)if(e.get(i.to)&&e.get(i.from)){const n=e.get(i.to);if(i.placement===a.db.PLACEMENT.LEFTOF&&!n.prevActor||i.placement===a.db.PLACEMENT.RIGHTOF&&!n.nextActor)continue;const s=i.placement!==void 0,o=!s,E=s?bt(l):Rt(l),h=i.wrap?Z.wrapLabel(i.message,l.width-2*l.wrapPadding,E):i.message,_=(Q(h)?await kt(i.message,j()):Z.calculateTextDimensions(h,E)).width+2*l.wrapPadding;o&&i.from===n.nextActor?r[i.to]=m.getMax(r[i.to]||0,_):o&&i.from===n.prevActor?r[i.from]=m.getMax(r[i.from]||0,_):o&&i.from===i.to?(r[i.from]=m.getMax(r[i.from]||0,_/2),r[i.to]=m.getMax(r[i.to]||0,_/2)):i.placement===a.db.PLACEMENT.RIGHTOF?r[i.from]=m.getMax(r[i.from]||0,_):i.placement===a.db.PLACEMENT.LEFTOF?r[n.prevActor]=m.getMax(r[n.prevActor]||0,_):i.placement===a.db.PLACEMENT.OVER&&(n.prevActor&&(r[n.prevActor]=m.getMax(r[n.prevActor]||0,_/2)),n.nextActor&&(r[i.from]=m.getMax(r[i.from]||0,_/2)))}return it.debug("maxMessageWidthPerActor:",r),r}x(Ge,"getMaxMessageWidthPerActor");var ra=x(function(e){let t=0;const a=re(l);for(const r in e.links){const n=Z.calculateTextDimensions(r,a).width+2*l.wrapPadding+2*l.boxMargin;t<n&&(t=n)}return t},"getRequiredPopupWidth");async function Xe(e,t,a){let r=0;for(const n of e.keys()){const s=e.get(n);s.wrap&&(s.description=Z.wrapLabel(s.description,l.width-2*l.wrapPadding,re(l)));const o=Q(s.description)?await kt(s.description,j()):Z.calculateTextDimensions(s.description,re(l));s.width=s.wrap?l.width:m.getMax(l.width,o.width+2*l.wrapPadding),s.height=s.wrap?m.getMax(o.height,l.height):l.height,r=m.getMax(r,s.height)}for(const n in t){const s=e.get(n);if(!s)continue;const o=e.get(s.nextActor);if(!o){const _=t[n]+l.actorMargin-s.width/2;s.margin=m.getMax(_,l.actorMargin);continue}const h=t[n]+l.actorMargin-s.width/2-o.width/2;s.margin=m.getMax(h,l.actorMargin)}let i=0;return a.forEach(n=>{const s=Rt(l);let o=n.actorKeys.reduce((_,u)=>_+=e.get(u).width+(e.get(u).margin||0),0);const E=l.boxMargin*8;o+=E,o-=2*l.boxTextMargin,n.wrap&&(n.name=Z.wrapLabel(n.name,o-2*l.wrapPadding,s));const h=Z.calculateTextDimensions(n.name,s);i=m.getMax(h.height,i);const p=m.getMax(o,h.width+2*l.wrapPadding);if(n.margin=l.boxTextMargin,o<p){const _=(p-o)/2;n.margin+=_}}),a.forEach(n=>n.textMaxHeight=i),m.getMax(r,l.height)}x(Xe,"calculateActorMargins");var aa=x(async function(e,t,a){const r=t.get(e.from),i=t.get(e.to),n=r.x,s=i.x,o=e.wrap&&e.message;let E=Q(e.message)?await kt(e.message,j()):Z.calculateTextDimensions(o?Z.wrapLabel(e.message,l.width,bt(l)):e.message,bt(l));const h={width:o?l.width:m.getMax(l.width,E.width+2*l.noteMargin),height:0,startx:r.x,stopx:0,starty:0,stopy:0,message:e.message};return e.placement===a.db.PLACEMENT.RIGHTOF?(h.width=o?m.getMax(l.width,E.width):m.getMax(r.width/2+i.width/2,E.width+2*l.noteMargin),h.startx=n+(r.width+l.actorMargin)/2):e.placement===a.db.PLACEMENT.LEFTOF?(h.width=o?m.getMax(l.width,E.width+2*l.noteMargin):m.getMax(r.width/2+i.width/2,E.width+2*l.noteMargin),h.startx=n-h.width+(r.width-l.actorMargin)/2):e.to===e.from?(E=Z.calculateTextDimensions(o?Z.wrapLabel(e.message,m.getMax(l.width,r.width),bt(l)):e.message,bt(l)),h.width=o?m.getMax(l.width,r.width):m.getMax(r.width,l.width,E.width+2*l.noteMargin),h.startx=n+(r.width-h.width)/2):(h.width=Math.abs(n+r.width/2-(s+i.width/2))+l.actorMargin,h.startx=n<s?n+r.width/2-l.actorMargin/2:s+i.width/2-l.actorMargin/2),o&&(h.message=Z.wrapLabel(e.message,h.width-2*l.wrapPadding,bt(l))),it.debug(`NM:[${h.startx},${h.stopx},${h.starty},${h.stopy}:${h.width},${h.height}=${e.message}]`),h},"buildNoteModel"),sa=4,te=x(function(e,t){const{CENTRAL_CONNECTION:a,CENTRAL_CONNECTION_REVERSE:r,CENTRAL_CONNECTION_DUAL:i}=t.db.LINETYPE;return[a,r,i].includes(e.centralConnection)},"hasCentralConnection"),ia=x(function(e,t,a){const{CENTRAL_CONNECTION_REVERSE:r,CENTRAL_CONNECTION_DUAL:i,BIDIRECTIONAL_SOLID:n,BIDIRECTIONAL_DOTTED:s}=t.db.LINETYPE;let o=0;return(e.centralConnection===r||e.centralConnection===i)&&(o+=sa),(e.centralConnection===r||e.centralConnection===i)&&(e.type===n||e.type===s)&&(o+=a?0:-6),o},"calculateCentralConnectionOffset"),Je=x(function(e,t){const{SOLID_ARROW_TOP_REVERSE:a,SOLID_ARROW_TOP_REVERSE_DOTTED:r,SOLID_ARROW_BOTTOM_REVERSE:i,SOLID_ARROW_BOTTOM_REVERSE_DOTTED:n,STICK_ARROW_TOP_REVERSE:s,STICK_ARROW_TOP_REVERSE_DOTTED:o,STICK_ARROW_BOTTOM_REVERSE:E,STICK_ARROW_BOTTOM_REVERSE_DOTTED:h}=t.db.LINETYPE;return[a,r,i,n,s,o,E,h].includes(e.type)},"isReverseArrowType"),na=x(function(e,t){const{BIDIRECTIONAL_SOLID:a,BIDIRECTIONAL_DOTTED:r}=t.db.LINETYPE;return[a,r].includes(e.type)},"isBidirectionalArrowType"),oa=x(function(e,t,a){const{look:r}=j();if(![a.db.LINETYPE.SOLID_OPEN,a.db.LINETYPE.DOTTED_OPEN,a.db.LINETYPE.SOLID,a.db.LINETYPE.SOLID_TOP,a.db.LINETYPE.SOLID_BOTTOM,a.db.LINETYPE.STICK_TOP,a.db.LINETYPE.STICK_BOTTOM,a.db.LINETYPE.SOLID_TOP_DOTTED,a.db.LINETYPE.SOLID_BOTTOM_DOTTED,a.db.LINETYPE.STICK_TOP_DOTTED,a.db.LINETYPE.STICK_BOTTOM_DOTTED,a.db.LINETYPE.SOLID_ARROW_TOP_REVERSE,a.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE,a.db.LINETYPE.STICK_ARROW_TOP_REVERSE,a.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE,a.db.LINETYPE.SOLID_ARROW_TOP_REVERSE_DOTTED,a.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE_DOTTED,a.db.LINETYPE.STICK_ARROW_TOP_REVERSE_DOTTED,a.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE_DOTTED,a.db.LINETYPE.DOTTED,a.db.LINETYPE.SOLID_CROSS,a.db.LINETYPE.DOTTED_CROSS,a.db.LINETYPE.SOLID_POINT,a.db.LINETYPE.DOTTED_POINT,a.db.LINETYPE.BIDIRECTIONAL_SOLID,a.db.LINETYPE.BIDIRECTIONAL_DOTTED].includes(e.type))return{};const[i,n]=Ce(e.from,t),[s,o]=Ce(e.to,t),E=i<=s;let h=E?n:i,p=E?s:o;r==="neo"&&(e.type!==a.db.LINETYPE.SOLID_OPEN&&(p+=E?-3:3),(e.type===a.db.LINETYPE.BIDIRECTIONAL_SOLID||e.type===a.db.LINETYPE.BIDIRECTIONAL_DOTTED)&&(h+=E?3:-3)),h+=ia(e,a,E);const _=Math.abs(s-o)>2,u=x(f=>E?-f:f,"adjustValue");e.from===e.to?p=h:(e.activate&&!_&&(p+=u(l.activationWidth/2-1)),[a.db.LINETYPE.SOLID_OPEN,a.db.LINETYPE.DOTTED_OPEN,a.db.LINETYPE.STICK_TOP,a.db.LINETYPE.STICK_BOTTOM,a.db.LINETYPE.STICK_TOP_DOTTED,a.db.LINETYPE.STICK_BOTTOM_DOTTED,a.db.LINETYPE.SOLID_ARROW_TOP_REVERSE_DOTTED,a.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE_DOTTED,a.db.LINETYPE.STICK_ARROW_TOP_REVERSE,a.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE,a.db.LINETYPE.STICK_ARROW_TOP_REVERSE_DOTTED,a.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE_DOTTED,a.db.LINETYPE.SOLID_ARROW_TOP_REVERSE,a.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE].includes(e.type)||(p+=u(3)),[a.db.LINETYPE.BIDIRECTIONAL_SOLID,a.db.LINETYPE.BIDIRECTIONAL_DOTTED,a.db.LINETYPE.SOLID_ARROW_TOP_REVERSE_DOTTED,a.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE_DOTTED,a.db.LINETYPE.SOLID_ARROW_TOP_REVERSE,a.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE].includes(e.type)&&(h-=u(3)));const O=[i,n,s,o],T=Math.abs(h-p);e.wrap&&e.message&&(e.message=Z.wrapLabel(e.message,m.getMax(T+2*l.wrapPadding,l.width),Rt(l)));const g=Z.calculateTextDimensions(e.message,Rt(l));return{width:m.getMax(e.wrap?0:g.width+2*l.wrapPadding,T+2*l.wrapPadding,l.width),height:0,startx:h,stopx:p,starty:0,stopy:0,message:e.message,type:e.type,wrap:e.wrap,fromBounds:Math.min.apply(null,O),toBounds:Math.max.apply(null,O)}},"buildMessageModel"),ca=x(async function(e,t,a,r){const i={},n=[];let s,o,E;for(const h of e){switch(h.type){case r.db.LINETYPE.LOOP_START:case r.db.LINETYPE.ALT_START:case r.db.LINETYPE.OPT_START:case r.db.LINETYPE.PAR_START:case r.db.LINETYPE.PAR_OVER_START:case r.db.LINETYPE.CRITICAL_START:case r.db.LINETYPE.BREAK_START:n.push({id:h.id,msg:h.message,from:Number.MAX_SAFE_INTEGER,to:Number.MIN_SAFE_INTEGER,width:0});break;case r.db.LINETYPE.ALT_ELSE:case r.db.LINETYPE.PAR_AND:case r.db.LINETYPE.CRITICAL_OPTION:h.message&&(s=n.pop(),i[s.id]=s,i[h.id]=s,n.push(s));break;case r.db.LINETYPE.LOOP_END:case r.db.LINETYPE.ALT_END:case r.db.LINETYPE.OPT_END:case r.db.LINETYPE.PAR_END:case r.db.LINETYPE.CRITICAL_END:case r.db.LINETYPE.BREAK_END:s=n.pop(),i[s.id]=s;break;case r.db.LINETYPE.ACTIVE_START:{const _=t.get(h.from?h.from:h.to.actor),u=Ut(h.from?h.from:h.to.actor).length,O=_.x+_.width/2+(u-1)*l.activationWidth/2,T={startx:O,stopx:O+l.activationWidth,actor:h.from,enabled:!0};R.activations.push(T)}break;case r.db.LINETYPE.ACTIVE_END:{const _=R.activations.map(u=>u.actor).lastIndexOf(h.from);R.activations.splice(_,1).splice(0,1)}break}h.placement!==void 0?(o=await aa(h,t,r),h.noteModel=o,n.forEach(_=>{s=_,s.from=m.getMin(s.from,o.startx),s.to=m.getMax(s.to,o.startx+o.width),s.width=m.getMax(s.width,Math.abs(s.from-s.to))-l.labelBoxWidth})):(E=oa(h,t,r),h.msgModel=E,E.startx&&E.stopx&&n.length>0&&n.forEach(_=>{if(s=_,E.startx===E.stopx){const u=t.get(h.from),O=t.get(h.to);s.from=m.getMin(u.x-E.width/2,u.x-u.width/2,s.from),s.to=m.getMax(O.x+E.width/2,O.x+u.width/2,s.to),s.width=m.getMax(s.width,Math.abs(s.to-s.from))-l.labelBoxWidth}else s.from=m.getMin(E.startx,s.from),s.to=m.getMax(E.stopx,s.to),s.width=m.getMax(s.width,E.width)-l.labelBoxWidth}))}return R.activations=[],it.debug("Loop type widths:",i),i},"calculateLoopBounds"),la={bounds:R,drawActors:ae,drawActorsPopup:qe,setConf:ze,draw:ea},pa={parser:_r,get db(){return new yr},renderer:la,styles:Or,init:x(e=>{e.sequence||(e.sequence={}),e.wrap&&(e.sequence.wrap=e.wrap,rr({sequence:{wrap:e.wrap}}))},"init")};export{pa as diagram};
